...
export class SubmissionSettings extends pb_1.Message {
  #one_of_decls: number[][] = [];
  constructor(
    data?:
      | any[]
      | {
          with_trim?: boolean;
          with_case_sensitive?: boolean;
          with_whitespace?: boolean;
        },
  ) {
    super();
    ...
    if (!Array.isArray(data) && typeof data == "object") {
      if ("with_trim" in data && data.with_trim != undefined) {
        this.with_trim = data.with_trim;
      }
      if (
        "with_case_sensitive" in data &&
        data.with_case_sensitive != undefined
      ) {
        this.with_case_sensitive = data.with_case_sensitive;
      }
      if ("with_whitespace" in data && data.with_whitespace != undefined) {
        this.with_whitespace = data.with_whitespace;
      }
    }
  }
  get with_trim() {
  ...
  set with_trim(value: boolean) {
    pb_1.Message.setField(this, 1, value);
  }
  get with_case_sensitive() {
    return pb_1.Message.getFieldWithDefault(this, 2, false) as boolean;
  }
  set with_case_sensitive(value: boolean) {
    pb_1.Message.setField(this, 2, value);
  }
  get with_whitespace() {
    return pb_1.Message.getFieldWithDefault(this, 3, false) as boolean;
  }
  set with_whitespace(value: boolean) {
  ...
  static fromObject(data: {
    ...
    const message = new SubmissionSettings({});
    if (data.with_trim != null) {
      message.with_trim = data.with_trim;
    }
    if (data.with_case_sensitive != null) {
      message.with_case_sensitive = data.with_case_sensitive;
    }
    if (data.with_whitespace != null) {
      message.with_whitespace = data.with_whitespace;
    }
    return message;
  }
  toObject() {
    ...
    if (this.with_trim != null) {
      data.with_trim = this.with_trim;
    }
    if (this.with_case_sensitive != null) {
      data.with_case_sensitive = this.with_case_sensitive;
    }
    if (this.with_whitespace != null) {
      data.with_whitespace = this.with_whitespace;
    }
    return data;
  }
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.with_trim != false) writer.writeBool(1, this.with_trim);
    if (this.with_case_sensitive != false)
      writer.writeBool(2, this.with_case_sensitive);
    if (this.with_whitespace != false)
      writer.writeBool(3, this.with_whitespace);
  ...
  static deserialize(
    ...
    const reader =
      ...
      message = new SubmissionSettings();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
          message.with_trim = reader.readBool();
          break;
        case 2:
          message.with_case_sensitive = reader.readBool();
          break;
        case 3:
          message.with_whitespace = reader.readBool();
          break;
        default:
          reader.skipField();
      }
  ...
  static deserializeBinary(bytes: Uint8Array): SubmissionSettings {
    return SubmissionSettings.deserialize(bytes);
  }
}
...
export class Submission extends pb_1.Message {
  ...
  get language() {
    return pb_1.Message.getWrapperField(this, Language, 2) as Language;
  }
  ...
  set settings(value: SubmissionSettings) {
  ...
  static fromObject(data: {
    ...
    settings?: ReturnType<typeof SubmissionSettings.prototype.toObject>;
  }): Submission {
    ...
    if (data.settings != null) {
      message.settings = SubmissionSettings.fromObject(data.settings);
    }
    return message;
  }
  toObject() {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.has_settings)
      writer.writeMessage(7, this.settings, () =>
    ...
    while (reader.nextField()) {
      ...
      switch (reader.getFieldNumber()) {
        ...
        case 7:
          reader.readMessage(
            message.settings,
            () => (message.settings = SubmissionSettings.deserialize(reader)),
          );
          break;
        default:
          reader.skipField();
