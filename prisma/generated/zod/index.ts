...
export const UserScalarFieldEnumSchema = z.enum(['id','name','email','emailVerified','image','hashPassword','createdAt','updatedAt','rules']);
...
export const RoleScalarFieldEnumSchema = z.enum(['roleId','roleName','description','rules','createdAt']);

export const ResourceScalarFieldEnumSchema = z.enum(['resourceId','resourceName','description','fields']);

export const ActionScalarFieldEnumSchema = z.enum(['actionId','actionName','description']);

export const LanguageScalarFieldEnumSchema = z.enum(['languageId','languageName','version','sourceFileExt','binaryFileExt','compileCommand','runCommand','isActive','canDelete','monacoCodeLanguage','templateCode']);

export const ProblemScalarFieldEnumSchema = z.enum(['problemId','title','description','problemStatement','difficultyLevel','timeLimitInMs','memoryLimitInKb','isPublic','totalSubmissions','acceptedSubmissions','createdAt','updatedAt','deletedAt','createdBy','updatedBy','deletedBy']);

export const ProblemLanguageScalarFieldEnumSchema = z.enum(['problemId','languageId','templateCode','timeLimitInMs','memoryLimitInKb']);

export const ProblemTagScalarFieldEnumSchema = z.enum(['problemId','tagId']);

export const SubmissionScalarFieldEnumSchema = z.enum(['submissionId','userId','problemId','languageId','code','status','timeExecutionInMs','memoryUsageInKb','submissionTime','createdAt','updatedAt','deletedAt','createdBy','updatedBy','deletedBy']);

export const SubmissionTestcaseScalarFieldEnumSchema = z.enum(['submissionId','testcaseId','status','stdout','problemId','runtimeInMs','memoryUsedInKb']);

export const TagScalarFieldEnumSchema = z.enum(['tagId','tagName','description','createdAt','createdBy']);

export const TestcaseScalarFieldEnumSchema = z.enum(['testCaseId','problemId','inputData','expectedOutput','isSample','points','label','explanation','createdAt','updatedAt','deletedAt','createdBy','updatedBy','deletedBy']);
...
export const ProblemSchema = z.object({
  ...
  timeLimitInMs: z.number().int(),
  memoryLimitInKb: z.number().int(),
  isPublic: z.boolean(),
...
export const SubmissionSchema = z.object({
  ...
  code: z.string(),
  status: z.string(),
  timeExecutionInMs: z.number().int(),
  memoryUsageInKb: z.number().int(),
...
export const SubmissionTestcaseSchema = z.object({
  ...
  problemId: z.string(),
  runtimeInMs: z.number().int(),
  memoryUsedInKb: z.number().int(),
})
...
export const ResourceSelectSchema: z.ZodType<Prisma.ResourceSelect> = z.object({
  ...
  resourceName: z.boolean().optional(),
  description: z.boolean().optional(),
...
export const LanguageIncludeSchema: z.ZodType<Prisma.LanguageInclude> = z.object({
  problemLanguages: z.union([z.boolean(),z.lazy(() => ProblemLanguageFindManyArgsSchema)]).optional(),
...
export const ProblemIncludeSchema: z.ZodType<Prisma.ProblemInclude> = z.object({
  problemLanguages: z.union([z.boolean(),z.lazy(() => ProblemLanguageFindManyArgsSchema)]).optional(),
  problemTags: z.union([z.boolean(),z.lazy(() => ProblemTagFindManyArgsSchema)]).optional(),
  submissions: z.union([z.boolean(),z.lazy(() => SubmissionFindManyArgsSchema)]).optional(),
  submissionTestcases: z.union([z.boolean(),z.lazy(() => SubmissionTestcaseFindManyArgsSchema)]).optional(),
...
export const ProblemSelectSchema: z.ZodType<Prisma.ProblemSelect> = z.object({
  ...
  timeLimitInMs: z.boolean().optional(),
  memoryLimitInKb: z.boolean().optional(),
...
export const ProblemLanguageIncludeSchema: z.ZodType<Prisma.ProblemLanguageInclude> = z.object({
  language: z.union([z.boolean(),z.lazy(() => LanguageArgsSchema)]).optional(),
  problem: z.union([z.boolean(),z.lazy(() => ProblemArgsSchema)]).optional(),
}).strict()

export const ProblemLanguageArgsSchema: z.ZodType<Prisma.ProblemLanguageDefaultArgs> = z.object({
  select: z.lazy(() => ProblemLanguageSelectSchema).optional(),
  include: z.lazy(() => ProblemLanguageIncludeSchema).optional(),
}).strict();

export const ProblemLanguageSelectSchema: z.ZodType<Prisma.ProblemLanguageSelect> = z.object({
  problemId: z.boolean().optional(),
  languageId: z.boolean().optional(),
  templateCode: z.boolean().optional(),
  timeLimitInMs: z.boolean().optional(),
...
export const SubmissionSelectSchema: z.ZodType<Prisma.SubmissionSelect> = z.object({
  ...
  timeExecutionInMs: z.boolean().optional(),
  memoryUsageInKb: z.boolean().optional(),
...
export const SubmissionTestcaseIncludeSchema: z.ZodType<Prisma.SubmissionTestcaseInclude> = z.object({
  problem: z.union([z.boolean(),z.lazy(() => ProblemArgsSchema)]).optional(),
  submission: z.union([z.boolean(),z.lazy(() => SubmissionArgsSchema)]).optional(),
}).strict()

export const SubmissionTestcaseArgsSchema: z.ZodType<Prisma.SubmissionTestcaseDefaultArgs> = z.object({
  select: z.lazy(() => SubmissionTestcaseSelectSchema).optional(),
  include: z.lazy(() => SubmissionTestcaseIncludeSchema).optional(),
}).strict();

export const SubmissionTestcaseSelectSchema: z.ZodType<Prisma.SubmissionTestcaseSelect> = z.object({
  submissionId: z.boolean().optional(),
  testcaseId: z.boolean().optional(),
  status: z.boolean().optional(),
  stdout: z.boolean().optional(),
  problemId: z.boolean().optional(),
  runtimeInMs: z.boolean().optional(),
  memoryUsedInKb: z.boolean().optional(),
  problem: z.union([z.boolean(),z.lazy(() => ProblemArgsSchema)]).optional(),
  submission: z.union([z.boolean(),z.lazy(() => SubmissionArgsSchema)]).optional(),
}).strict()
...
export const UserWhereInputSchema: z.ZodType<Prisma.UserWhereInput> = z.object({
  ...
  hashPassword: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  rules: z.lazy(() => JsonNullableFilterSchema).optional(),
...
export const UserOrderByWithRelationInputSchema: z.ZodType<Prisma.UserOrderByWithRelationInput> = z.object({
  ...
  hashPassword: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
...
export const UserScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.UserScalarWhereWithAggregatesInput> = z.object({
  ...
  hashPassword: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  rules: z.lazy(() => JsonNullableWithAggregatesFilterSchema).optional()
}).strict();
...
export const ResourceWhereInputSchema: z.ZodType<Prisma.ResourceWhereInput> = z.object({
  ...
  resourceName: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  description: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  fields: z.lazy(() => StringNullableListFilterSchema).optional()
}).strict();

export const ResourceOrderByWithRelationInputSchema: z.ZodType<Prisma.ResourceOrderByWithRelationInput> = z.object({
  resourceId: z.lazy(() => SortOrderSchema).optional(),
  resourceName: z.lazy(() => SortOrderSchema).optional(),
  description: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
...
export const ResourceScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ResourceScalarWhereWithAggregatesInput> = z.object({
  ...
  resourceName: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  description: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  fields: z.lazy(() => StringNullableListFilterSchema).optional()
}).strict();
...
export const LanguageWhereInputSchema: z.ZodType<Prisma.LanguageWhereInput> = z.object({
  ...
  languageName: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  version: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  sourceFileExt: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  binaryFileExt: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  compileCommand: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  runCommand: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  isActive: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  canDelete: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  monacoCodeLanguage: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  templateCode: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  problemLanguages: z.lazy(() => ProblemLanguageListRelationFilterSchema).optional()
}).strict();
...
export const LanguageOrderByWithRelationInputSchema: z.ZodType<Prisma.LanguageOrderByWithRelationInput> = z.object({
  ...
  binaryFileExt: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  compileCommand: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  runCommand: z.lazy(() => SortOrderSchema).optional(),
  isActive: z.lazy(() => SortOrderSchema).optional(),
  canDelete: z.lazy(() => SortOrderSchema).optional(),
  monacoCodeLanguage: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  templateCode: z.lazy(() => SortOrderSchema).optional(),
  problemLanguages: z.lazy(() => ProblemLanguageOrderByRelationAggregateInputSchema).optional()
}).strict();
...
export const LanguageScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.LanguageScalarWhereWithAggregatesInput> = z.object({
  ...
  languageName: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  version: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  sourceFileExt: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  binaryFileExt: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  compileCommand: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  runCommand: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  isActive: z.union([ z.lazy(() => BoolWithAggregatesFilterSchema),z.boolean() ]).optional(),
  canDelete: z.union([ z.lazy(() => BoolWithAggregatesFilterSchema),z.boolean() ]).optional(),
  monacoCodeLanguage: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  templateCode: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
}).strict();
...
export const ProblemWhereInputSchema: z.ZodType<Prisma.ProblemWhereInput> = z.object({
  ...
  difficultyLevel: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  timeLimitInMs: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  memoryLimitInKb: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  isPublic: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  totalSubmissions: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  acceptedSubmissions: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  ...
  submissionTestcases: z.lazy(() => SubmissionTestcaseListRelationFilterSchema).optional(),
...
export const ProblemOrderByWithRelationInputSchema: z.ZodType<Prisma.ProblemOrderByWithRelationInput> = z.object({
  ...
  timeLimitInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryLimitInKb: z.lazy(() => SortOrderSchema).optional(),
  ...
  problemLanguages: z.lazy(() => ProblemLanguageOrderByRelationAggregateInputSchema).optional(),
  problemTags: z.lazy(() => ProblemTagOrderByRelationAggregateInputSchema).optional(),
  submissions: z.lazy(() => SubmissionOrderByRelationAggregateInputSchema).optional(),
  submissionTestcases: z.lazy(() => SubmissionTestcaseOrderByRelationAggregateInputSchema).optional(),
...
.and(z.object({
  ...
  description: z.lazy(() => JsonNullableFilterSchema).optional(),
  problemStatement: z.lazy(() => JsonFilterSchema).optional(),
  difficultyLevel: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  timeLimitInMs: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  memoryLimitInKb: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  isPublic: z.union([ z.lazy(() => BoolFilterSchema),z.boolean() ]).optional(),
  totalSubmissions: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  acceptedSubmissions: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  deletedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  createdBy: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
...
export const ProblemScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ProblemScalarWhereWithAggregatesInput> = z.object({
  ...
  problemId: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema),z.string() ]).optional(),
  ...
  difficultyLevel: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  timeLimitInMs: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  memoryLimitInKb: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  isPublic: z.union([ z.lazy(() => BoolWithAggregatesFilterSchema),z.boolean() ]).optional(),
  totalSubmissions: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  acceptedSubmissions: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
...
export const ProblemLanguageWhereInputSchema: z.ZodType<Prisma.ProblemLanguageWhereInput> = z.object({
  AND: z.union([ z.lazy(() => ProblemLanguageWhereInputSchema),z.lazy(() => ProblemLanguageWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ProblemLanguageWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ProblemLanguageWhereInputSchema),z.lazy(() => ProblemLanguageWhereInputSchema).array() ]).optional(),
  problemId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  languageId: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  templateCode: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  timeLimitInMs: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  memoryLimitInKb: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
...
export const ProblemLanguageOrderByWithRelationInputSchema: z.ZodType<Prisma.ProblemLanguageOrderByWithRelationInput> = z.object({
  problemId: z.lazy(() => SortOrderSchema).optional(),
  languageId: z.lazy(() => SortOrderSchema).optional(),
  templateCode: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  timeLimitInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryLimitInKb: z.lazy(() => SortOrderSchema).optional(),
...
export const ProblemLanguageWhereUniqueInputSchema: z.ZodType<Prisma.ProblemLanguageWhereUniqueInput> = z.object({
  problemId_languageId: z.lazy(() => ProblemLanguageProblemIdLanguageIdCompoundUniqueInputSchema)
})
.and(z.object({
  problemId_languageId: z.lazy(() => ProblemLanguageProblemIdLanguageIdCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => ProblemLanguageWhereInputSchema),z.lazy(() => ProblemLanguageWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ProblemLanguageWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ProblemLanguageWhereInputSchema),z.lazy(() => ProblemLanguageWhereInputSchema).array() ]).optional(),
  problemId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
...
export const ProblemLanguageOrderByWithAggregationInputSchema: z.ZodType<Prisma.ProblemLanguageOrderByWithAggregationInput> = z.object({
  problemId: z.lazy(() => SortOrderSchema).optional(),
  languageId: z.lazy(() => SortOrderSchema).optional(),
  templateCode: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  timeLimitInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryLimitInKb: z.lazy(() => SortOrderSchema).optional(),
  _count: z.lazy(() => ProblemLanguageCountOrderByAggregateInputSchema).optional(),
  _avg: z.lazy(() => ProblemLanguageAvgOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => ProblemLanguageMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => ProblemLanguageMinOrderByAggregateInputSchema).optional(),
  _sum: z.lazy(() => ProblemLanguageSumOrderByAggregateInputSchema).optional()
}).strict();

export const ProblemLanguageScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.ProblemLanguageScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => ProblemLanguageScalarWhereWithAggregatesInputSchema),z.lazy(() => ProblemLanguageScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => ProblemLanguageScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ProblemLanguageScalarWhereWithAggregatesInputSchema),z.lazy(() => ProblemLanguageScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  problemId: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema),z.string() ]).optional(),
  languageId: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  templateCode: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  timeLimitInMs: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  memoryLimitInKb: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
}).strict();
...
export const ProblemTagWhereUniqueInputSchema: z.ZodType<Prisma.ProblemTagWhereUniqueInput> = z.object({
...
export const SubmissionWhereInputSchema: z.ZodType<Prisma.SubmissionWhereInput> = z.object({
  ...
  timeExecutionInMs: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  memoryUsageInKb: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  submissionTime: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  deletedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  createdBy: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
...
export const SubmissionOrderByWithRelationInputSchema: z.ZodType<Prisma.SubmissionOrderByWithRelationInput> = z.object({
  ...
  timeExecutionInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryUsageInKb: z.lazy(() => SortOrderSchema).optional(),
  submissionTime: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
  deletedAt: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  createdBy: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
...
.and(z.object({
  ...
  code: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  status: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  timeExecutionInMs: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  memoryUsageInKb: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  submissionTime: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema),z.coerce.date() ]).optional(),
  deletedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema),z.coerce.date() ]).optional().nullable(),
...
export const SubmissionScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.SubmissionScalarWhereWithAggregatesInput> = z.object({
  ...
  timeExecutionInMs: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  memoryUsageInKb: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  submissionTime: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema),z.coerce.date() ]).optional().nullable(),
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  deletedAt: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema),z.coerce.date() ]).optional().nullable(),
  createdBy: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
...
export const SubmissionTestcaseWhereInputSchema: z.ZodType<Prisma.SubmissionTestcaseWhereInput> = z.object({
  AND: z.union([ z.lazy(() => SubmissionTestcaseWhereInputSchema),z.lazy(() => SubmissionTestcaseWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => SubmissionTestcaseWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SubmissionTestcaseWhereInputSchema),z.lazy(() => SubmissionTestcaseWhereInputSchema).array() ]).optional(),
  submissionId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  testcaseId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  status: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  stdout: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  problemId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  runtimeInMs: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  memoryUsedInKb: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  problem: z.union([ z.lazy(() => ProblemScalarRelationFilterSchema),z.lazy(() => ProblemWhereInputSchema) ]).optional(),
  submission: z.union([ z.lazy(() => SubmissionScalarRelationFilterSchema),z.lazy(() => SubmissionWhereInputSchema) ]).optional(),
}).strict();

export const SubmissionTestcaseOrderByWithRelationInputSchema: z.ZodType<Prisma.SubmissionTestcaseOrderByWithRelationInput> = z.object({
  submissionId: z.lazy(() => SortOrderSchema).optional(),
  testcaseId: z.lazy(() => SortOrderSchema).optional(),
  status: z.lazy(() => SortOrderSchema).optional(),
  stdout: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  problemId: z.lazy(() => SortOrderSchema).optional(),
  runtimeInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryUsedInKb: z.lazy(() => SortOrderSchema).optional(),
  problem: z.lazy(() => ProblemOrderByWithRelationInputSchema).optional(),
  submission: z.lazy(() => SubmissionOrderByWithRelationInputSchema).optional()
}).strict();

export const SubmissionTestcaseWhereUniqueInputSchema: z.ZodType<Prisma.SubmissionTestcaseWhereUniqueInput> = z.object({
  submissionId_testcaseId: z.lazy(() => SubmissionTestcaseSubmissionIdTestcaseIdCompoundUniqueInputSchema)
})
.and(z.object({
  submissionId_testcaseId: z.lazy(() => SubmissionTestcaseSubmissionIdTestcaseIdCompoundUniqueInputSchema).optional(),
  AND: z.union([ z.lazy(() => SubmissionTestcaseWhereInputSchema),z.lazy(() => SubmissionTestcaseWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => SubmissionTestcaseWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SubmissionTestcaseWhereInputSchema),z.lazy(() => SubmissionTestcaseWhereInputSchema).array() ]).optional(),
  submissionId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  ...
  stdout: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  problemId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  runtimeInMs: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  memoryUsedInKb: z.union([ z.lazy(() => IntFilterSchema),z.number().int() ]).optional(),
  problem: z.union([ z.lazy(() => ProblemScalarRelationFilterSchema),z.lazy(() => ProblemWhereInputSchema) ]).optional(),
  submission: z.union([ z.lazy(() => SubmissionScalarRelationFilterSchema),z.lazy(() => SubmissionWhereInputSchema) ]).optional(),
}).strict());

export const SubmissionTestcaseOrderByWithAggregationInputSchema: z.ZodType<Prisma.SubmissionTestcaseOrderByWithAggregationInput> = z.object({
  submissionId: z.lazy(() => SortOrderSchema).optional(),
  testcaseId: z.lazy(() => SortOrderSchema).optional(),
  status: z.lazy(() => SortOrderSchema).optional(),
  stdout: z.union([ z.lazy(() => SortOrderSchema),z.lazy(() => SortOrderInputSchema) ]).optional(),
  ...
  runtimeInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryUsedInKb: z.lazy(() => SortOrderSchema).optional(),
  _count: z.lazy(() => SubmissionTestcaseCountOrderByAggregateInputSchema).optional(),
  _avg: z.lazy(() => SubmissionTestcaseAvgOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => SubmissionTestcaseMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => SubmissionTestcaseMinOrderByAggregateInputSchema).optional(),
  _sum: z.lazy(() => SubmissionTestcaseSumOrderByAggregateInputSchema).optional()
}).strict();

export const SubmissionTestcaseScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.SubmissionTestcaseScalarWhereWithAggregatesInput> = z.object({
  AND: z.union([ z.lazy(() => SubmissionTestcaseScalarWhereWithAggregatesInputSchema),z.lazy(() => SubmissionTestcaseScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => SubmissionTestcaseScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SubmissionTestcaseScalarWhereWithAggregatesInputSchema),z.lazy(() => SubmissionTestcaseScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  submissionId: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema),z.string() ]).optional(),
  testcaseId: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema),z.string() ]).optional(),
  status: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  stdout: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
  problemId: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema),z.string() ]).optional(),
  runtimeInMs: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
  memoryUsedInKb: z.union([ z.lazy(() => IntWithAggregatesFilterSchema),z.number() ]).optional(),
}).strict();
...
export const TestcaseWhereInputSchema: z.ZodType<Prisma.TestcaseWhereInput> = z.object({
  ...
  testCaseId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  problemId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  inputData: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  expectedOutput: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
...
export const TestcaseScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.TestcaseScalarWhereWithAggregatesInput> = z.object({
  ...
  testCaseId: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema),z.string() ]).optional(),
  problemId: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema),z.string() ]).optional(),
  inputData: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  expectedOutput: z.union([ z.lazy(() => StringWithAggregatesFilterSchema),z.string() ]).optional(),
  isSample: z.union([ z.lazy(() => BoolWithAggregatesFilterSchema),z.boolean() ]).optional(),
  ...
  explanation: z.lazy(() => JsonNullableWithAggregatesFilterSchema).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema),z.coerce.date() ]).optional(),
  deletedAt: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema),z.coerce.date() ]).optional().nullable(),
  createdBy: z.union([ z.lazy(() => StringNullableWithAggregatesFilterSchema),z.string() ]).optional().nullable(),
...
export const UserCreateInputSchema: z.ZodType<Prisma.UserCreateInput> = z.object({
  ...
  rules: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  accounts: z.lazy(() => AccountCreateNestedManyWithoutUserInputSchema).optional(),
  sessions: z.lazy(() => SessionCreateNestedManyWithoutUserInputSchema).optional(),
  Authenticator: z.lazy(() => AuthenticatorCreateNestedManyWithoutUserInputSchema).optional(),
  Role: z.lazy(() => RoleCreateNestedManyWithoutUsersInputSchema).optional()
}).strict();
...
export const UserUncheckedCreateInputSchema: z.ZodType<Prisma.UserUncheckedCreateInput> = z.object({
  ...
  Role: z.lazy(() => RoleUncheckedCreateNestedManyWithoutUsersInputSchema).optional()
}).strict();
...
export const UserUpdateInputSchema: z.ZodType<Prisma.UserUpdateInput> = z.object({
  ...
  hashPassword: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  Role: z.lazy(() => RoleUpdateManyWithoutUsersNestedInputSchema).optional()
}).strict();
...
export const UserUncheckedUpdateInputSchema: z.ZodType<Prisma.UserUncheckedUpdateInput> = z.object({
  ...
  Role: z.lazy(() => RoleUncheckedUpdateManyWithoutUsersNestedInputSchema).optional()
}).strict();
...
export const ResourceCreateInputSchema: z.ZodType<Prisma.ResourceCreateInput> = z.object({
  ...
  resourceName: z.string(),
  description: z.string().optional().nullable(),
  fields: z.union([ z.lazy(() => ResourceCreatefieldsInputSchema),z.string().array() ]).optional(),
}).strict();
...
export const ResourceUpdateInputSchema: z.ZodType<Prisma.ResourceUpdateInput> = z.object({
  ...
  resourceName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  fields: z.union([ z.lazy(() => ResourceUpdatefieldsInputSchema),z.string().array() ]).optional(),
}).strict();
...
export const LanguageCreateInputSchema: z.ZodType<Prisma.LanguageCreateInput> = z.object({
  ...
  problemLanguages: z.lazy(() => ProblemLanguageCreateNestedManyWithoutLanguageInputSchema).optional()
}).strict();
...
export const LanguageUncheckedCreateInputSchema: z.ZodType<Prisma.LanguageUncheckedCreateInput> = z.object({
  ...
  monacoCodeLanguage: z.string().optional().nullable(),
  templateCode: z.string().optional(),
  problemLanguages: z.lazy(() => ProblemLanguageUncheckedCreateNestedManyWithoutLanguageInputSchema).optional()
}).strict();

export const LanguageUpdateInputSchema: z.ZodType<Prisma.LanguageUpdateInput> = z.object({
  languageName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  version: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  sourceFileExt: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  binaryFileExt: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  compileCommand: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  runCommand: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  isActive: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
  canDelete: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
  monacoCodeLanguage: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  templateCode: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  problemLanguages: z.lazy(() => ProblemLanguageUpdateManyWithoutLanguageNestedInputSchema).optional()
}).strict();
...
export const LanguageUncheckedUpdateInputSchema: z.ZodType<Prisma.LanguageUncheckedUpdateInput> = z.object({
  ...
  monacoCodeLanguage: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  templateCode: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  problemLanguages: z.lazy(() => ProblemLanguageUncheckedUpdateManyWithoutLanguageNestedInputSchema).optional()
}).strict();
...
export const ProblemCreateInputSchema: z.ZodType<Prisma.ProblemCreateInput> = z.object({
  ...
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
  difficultyLevel: z.number().int().optional(),
  timeLimitInMs: z.number().int().optional(),
  memoryLimitInKb: z.number().int().optional(),
  isPublic: z.boolean().optional(),
  ...
  problemLanguages: z.lazy(() => ProblemLanguageCreateNestedManyWithoutProblemInputSchema).optional(),
  problemTags: z.lazy(() => ProblemTagCreateNestedManyWithoutProblemInputSchema).optional(),
  submissions: z.lazy(() => SubmissionCreateNestedManyWithoutProblemInputSchema).optional(),
  submissionTestcases: z.lazy(() => SubmissionTestcaseCreateNestedManyWithoutProblemInputSchema).optional(),
  testcases: z.lazy(() => TestcaseCreateNestedManyWithoutProblemInputSchema).optional()
}).strict();
...
export const ProblemUncheckedCreateInputSchema: z.ZodType<Prisma.ProblemUncheckedCreateInput> = z.object({
  ...
  updatedBy: z.string().optional().nullable(),
  deletedBy: z.string().optional().nullable(),
  problemLanguages: z.lazy(() => ProblemLanguageUncheckedCreateNestedManyWithoutProblemInputSchema).optional(),
  problemTags: z.lazy(() => ProblemTagUncheckedCreateNestedManyWithoutProblemInputSchema).optional(),
  submissions: z.lazy(() => SubmissionUncheckedCreateNestedManyWithoutProblemInputSchema).optional(),
  submissionTestcases: z.lazy(() => SubmissionTestcaseUncheckedCreateNestedManyWithoutProblemInputSchema).optional(),
  testcases: z.lazy(() => TestcaseUncheckedCreateNestedManyWithoutProblemInputSchema).optional()
}).strict();

export const ProblemUpdateInputSchema: z.ZodType<Prisma.ProblemUpdateInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  difficultyLevel: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryLimitInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  isPublic: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
  totalSubmissions: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  acceptedSubmissions: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  problemLanguages: z.lazy(() => ProblemLanguageUpdateManyWithoutProblemNestedInputSchema).optional(),
  problemTags: z.lazy(() => ProblemTagUpdateManyWithoutProblemNestedInputSchema).optional(),
  submissions: z.lazy(() => SubmissionUpdateManyWithoutProblemNestedInputSchema).optional(),
  submissionTestcases: z.lazy(() => SubmissionTestcaseUpdateManyWithoutProblemNestedInputSchema).optional(),
  testcases: z.lazy(() => TestcaseUpdateManyWithoutProblemNestedInputSchema).optional()
}).strict();
...
export const ProblemUncheckedUpdateInputSchema: z.ZodType<Prisma.ProblemUncheckedUpdateInput> = z.object({
  ...
  updatedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  deletedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  problemLanguages: z.lazy(() => ProblemLanguageUncheckedUpdateManyWithoutProblemNestedInputSchema).optional(),
  problemTags: z.lazy(() => ProblemTagUncheckedUpdateManyWithoutProblemNestedInputSchema).optional(),
  submissions: z.lazy(() => SubmissionUncheckedUpdateManyWithoutProblemNestedInputSchema).optional(),
  submissionTestcases: z.lazy(() => SubmissionTestcaseUncheckedUpdateManyWithoutProblemNestedInputSchema).optional(),
  testcases: z.lazy(() => TestcaseUncheckedUpdateManyWithoutProblemNestedInputSchema).optional()
}).strict();
...
export const ProblemLanguageCreateInputSchema: z.ZodType<Prisma.ProblemLanguageCreateInput> = z.object({
  templateCode: z.string().optional().nullable(),
  timeLimitInMs: z.number().int().optional(),
  memoryLimitInKb: z.number().int().optional(),
  language: z.lazy(() => LanguageCreateNestedOneWithoutProblemLanguagesInputSchema),
  problem: z.lazy(() => ProblemCreateNestedOneWithoutProblemLanguagesInputSchema)
}).strict();

export const ProblemLanguageUncheckedCreateInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedCreateInput> = z.object({
  problemId: z.string(),
  languageId: z.number().int(),
  templateCode: z.string().optional().nullable(),
  timeLimitInMs: z.number().int().optional(),
...
export const ProblemLanguageUpdateInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateInput> = z.object({
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryLimitInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  language: z.lazy(() => LanguageUpdateOneRequiredWithoutProblemLanguagesNestedInputSchema).optional(),
  problem: z.lazy(() => ProblemUpdateOneRequiredWithoutProblemLanguagesNestedInputSchema).optional()
}).strict();

export const ProblemLanguageUncheckedUpdateInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedUpdateInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  languageId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProblemLanguageCreateManyInputSchema: z.ZodType<Prisma.ProblemLanguageCreateManyInput> = z.object({
  problemId: z.string(),
  languageId: z.number().int(),
  templateCode: z.string().optional().nullable(),
  timeLimitInMs: z.number().int().optional(),
...
export const ProblemLanguageUpdateManyMutationInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateManyMutationInput> = z.object({
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryLimitInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
}).strict();

export const ProblemLanguageUncheckedUpdateManyInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedUpdateManyInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  languageId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProblemTagCreateInputSchema: z.ZodType<Prisma.ProblemTagCreateInput> = z.object({
  problem: z.lazy(() => ProblemCreateNestedOneWithoutProblemTagsInputSchema),
...
export const ProblemTagUpdateInputSchema: z.ZodType<Prisma.ProblemTagUpdateInput> = z.object({
  problem: z.lazy(() => ProblemUpdateOneRequiredWithoutProblemTagsNestedInputSchema).optional(),
  tag: z.lazy(() => TagUpdateOneRequiredWithoutProblemTagsNestedInputSchema).optional()
}).strict();
...
export const SubmissionCreateInputSchema: z.ZodType<Prisma.SubmissionCreateInput> = z.object({
  ...
  status: z.string(),
  timeExecutionInMs: z.number().int(),
  memoryUsageInKb: z.number().int().optional(),
  ...
  updatedBy: z.string().optional().nullable(),
  deletedBy: z.string().optional().nullable(),
  problem: z.lazy(() => ProblemCreateNestedOneWithoutSubmissionsInputSchema),
  submissionTestcases: z.lazy(() => SubmissionTestcaseCreateNestedManyWithoutSubmissionInputSchema).optional()
}).strict();
...
export const SubmissionUncheckedCreateInputSchema: z.ZodType<Prisma.SubmissionUncheckedCreateInput> = z.object({
  ...
  updatedBy: z.string().optional().nullable(),
  deletedBy: z.string().optional().nullable(),
  submissionTestcases: z.lazy(() => SubmissionTestcaseUncheckedCreateNestedManyWithoutSubmissionInputSchema).optional()
}).strict();
...
export const SubmissionUpdateInputSchema: z.ZodType<Prisma.SubmissionUpdateInput> = z.object({
  ...
  timeExecutionInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryUsageInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  submissionTime: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  deletedAt: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  createdBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  updatedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  deletedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  problem: z.lazy(() => ProblemUpdateOneRequiredWithoutSubmissionsNestedInputSchema).optional(),
  submissionTestcases: z.lazy(() => SubmissionTestcaseUpdateManyWithoutSubmissionNestedInputSchema).optional()
}).strict();
...
export const SubmissionUncheckedUpdateInputSchema: z.ZodType<Prisma.SubmissionUncheckedUpdateInput> = z.object({
  ...
  updatedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  deletedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  submissionTestcases: z.lazy(() => SubmissionTestcaseUncheckedUpdateManyWithoutSubmissionNestedInputSchema).optional()
}).strict();
...
export const SubmissionTestcaseCreateInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateInput> = z.object({
  testcaseId: z.string(),
  status: z.string(),
  stdout: z.string().optional().nullable(),
  runtimeInMs: z.number().int().optional(),
  memoryUsedInKb: z.number().int().optional(),
  problem: z.lazy(() => ProblemCreateNestedOneWithoutSubmissionTestcasesInputSchema),
  submission: z.lazy(() => SubmissionCreateNestedOneWithoutSubmissionTestcasesInputSchema)
}).strict();

export const SubmissionTestcaseUncheckedCreateInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedCreateInput> = z.object({
  submissionId: z.string(),
  testcaseId: z.string(),
  status: z.string(),
  stdout: z.string().optional().nullable(),
...
export const SubmissionTestcaseUpdateInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateInput> = z.object({
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  runtimeInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryUsedInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  problem: z.lazy(() => ProblemUpdateOneRequiredWithoutSubmissionTestcasesNestedInputSchema).optional(),
  submission: z.lazy(() => SubmissionUpdateOneRequiredWithoutSubmissionTestcasesNestedInputSchema).optional()
}).strict();

export const SubmissionTestcaseUncheckedUpdateInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedUpdateInput> = z.object({
  submissionId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SubmissionTestcaseCreateManyInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateManyInput> = z.object({
  submissionId: z.string(),
  testcaseId: z.string(),
  status: z.string(),
  stdout: z.string().optional().nullable(),
...
export const SubmissionTestcaseUpdateManyMutationInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateManyMutationInput> = z.object({
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  runtimeInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubmissionTestcaseUncheckedUpdateManyInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedUpdateManyInput> = z.object({
  submissionId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const TagCreateInputSchema: z.ZodType<Prisma.TagCreateInput> = z.object({
  ...
  createdAt: z.coerce.date().optional(),
  createdBy: z.string().optional().nullable(),
  problemTags: z.lazy(() => ProblemTagCreateNestedManyWithoutTagInputSchema).optional()
}).strict();
...
export const TagUncheckedCreateInputSchema: z.ZodType<Prisma.TagUncheckedCreateInput> = z.object({
  ...
  createdAt: z.coerce.date().optional(),
  createdBy: z.string().optional().nullable(),
  problemTags: z.lazy(() => ProblemTagUncheckedCreateNestedManyWithoutTagInputSchema).optional()
}).strict();
...
export const TagUpdateInputSchema: z.ZodType<Prisma.TagUpdateInput> = z.object({
  ...
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  createdBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  problemTags: z.lazy(() => ProblemTagUpdateManyWithoutTagNestedInputSchema).optional()
}).strict();
...
export const TagUncheckedUpdateInputSchema: z.ZodType<Prisma.TagUncheckedUpdateInput> = z.object({
  ...
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  createdBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  problemTags: z.lazy(() => ProblemTagUncheckedUpdateManyWithoutTagNestedInputSchema).optional()
}).strict();
...
export const TestcaseCreateInputSchema: z.ZodType<Prisma.TestcaseCreateInput> = z.object({
  ...
  explanation: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  deletedAt: z.coerce.date().optional().nullable(),
  createdBy: z.string().optional().nullable(),
...
export const TestcaseUpdateInputSchema: z.ZodType<Prisma.TestcaseUpdateInput> = z.object({
  testCaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  inputData: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  expectedOutput: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  isSample: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  updatedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  deletedBy: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  problem: z.lazy(() => ProblemUpdateOneRequiredWithoutTestcasesNestedInputSchema).optional()
}).strict();
...
export const ProblemLanguageListRelationFilterSchema: z.ZodType<Prisma.ProblemLanguageListRelationFilter> = z.object({
...
export const ProblemLanguageOrderByRelationAggregateInputSchema: z.ZodType<Prisma.ProblemLanguageOrderByRelationAggregateInput> = z.object({
  _count: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const SubmissionTestcaseListRelationFilterSchema: z.ZodType<Prisma.SubmissionTestcaseListRelationFilter> = z.object({
...
export const SubmissionTestcaseOrderByRelationAggregateInputSchema: z.ZodType<Prisma.SubmissionTestcaseOrderByRelationAggregateInput> = z.object({
  _count: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const ProblemLanguageProblemIdLanguageIdCompoundUniqueInputSchema: z.ZodType<Prisma.ProblemLanguageProblemIdLanguageIdCompoundUniqueInput> = z.object({
  problemId: z.string(),
  languageId: z.number()
}).strict();

export const ProblemLanguageCountOrderByAggregateInputSchema: z.ZodType<Prisma.ProblemLanguageCountOrderByAggregateInput> = z.object({
  problemId: z.lazy(() => SortOrderSchema).optional(),
  languageId: z.lazy(() => SortOrderSchema).optional(),
  templateCode: z.lazy(() => SortOrderSchema).optional(),
  timeLimitInMs: z.lazy(() => SortOrderSchema).optional(),
...
export const ProblemLanguageAvgOrderByAggregateInputSchema: z.ZodType<Prisma.ProblemLanguageAvgOrderByAggregateInput> = z.object({
  languageId: z.lazy(() => SortOrderSchema).optional(),
  timeLimitInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryLimitInKb: z.lazy(() => SortOrderSchema).optional()
}).strict();

export const ProblemLanguageMaxOrderByAggregateInputSchema: z.ZodType<Prisma.ProblemLanguageMaxOrderByAggregateInput> = z.object({
  problemId: z.lazy(() => SortOrderSchema).optional(),
  languageId: z.lazy(() => SortOrderSchema).optional(),
  templateCode: z.lazy(() => SortOrderSchema).optional(),
  timeLimitInMs: z.lazy(() => SortOrderSchema).optional(),
...
export const ProblemLanguageMinOrderByAggregateInputSchema: z.ZodType<Prisma.ProblemLanguageMinOrderByAggregateInput> = z.object({
  problemId: z.lazy(() => SortOrderSchema).optional(),
  languageId: z.lazy(() => SortOrderSchema).optional(),
  templateCode: z.lazy(() => SortOrderSchema).optional(),
  timeLimitInMs: z.lazy(() => SortOrderSchema).optional(),
...
export const ProblemLanguageSumOrderByAggregateInputSchema: z.ZodType<Prisma.ProblemLanguageSumOrderByAggregateInput> = z.object({
  languageId: z.lazy(() => SortOrderSchema).optional(),
  timeLimitInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryLimitInKb: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const SubmissionScalarRelationFilterSchema: z.ZodType<Prisma.SubmissionScalarRelationFilter> = z.object({
  is: z.lazy(() => SubmissionWhereInputSchema).optional(),
  isNot: z.lazy(() => SubmissionWhereInputSchema).optional()
}).strict();

export const SubmissionTestcaseSubmissionIdTestcaseIdCompoundUniqueInputSchema: z.ZodType<Prisma.SubmissionTestcaseSubmissionIdTestcaseIdCompoundUniqueInput> = z.object({
  submissionId: z.string(),
  testcaseId: z.string()
}).strict();

export const SubmissionTestcaseCountOrderByAggregateInputSchema: z.ZodType<Prisma.SubmissionTestcaseCountOrderByAggregateInput> = z.object({
  submissionId: z.lazy(() => SortOrderSchema).optional(),
  testcaseId: z.lazy(() => SortOrderSchema).optional(),
  status: z.lazy(() => SortOrderSchema).optional(),
...
export const SubmissionTestcaseAvgOrderByAggregateInputSchema: z.ZodType<Prisma.SubmissionTestcaseAvgOrderByAggregateInput> = z.object({
  runtimeInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryUsedInKb: z.lazy(() => SortOrderSchema).optional()
}).strict();

export const SubmissionTestcaseMaxOrderByAggregateInputSchema: z.ZodType<Prisma.SubmissionTestcaseMaxOrderByAggregateInput> = z.object({
  submissionId: z.lazy(() => SortOrderSchema).optional(),
  testcaseId: z.lazy(() => SortOrderSchema).optional(),
  status: z.lazy(() => SortOrderSchema).optional(),
  stdout: z.lazy(() => SortOrderSchema).optional(),
...
export const SubmissionTestcaseMinOrderByAggregateInputSchema: z.ZodType<Prisma.SubmissionTestcaseMinOrderByAggregateInput> = z.object({
  submissionId: z.lazy(() => SortOrderSchema).optional(),
  testcaseId: z.lazy(() => SortOrderSchema).optional(),
  status: z.lazy(() => SortOrderSchema).optional(),
  stdout: z.lazy(() => SortOrderSchema).optional(),
...
export const SubmissionTestcaseSumOrderByAggregateInputSchema: z.ZodType<Prisma.SubmissionTestcaseSumOrderByAggregateInput> = z.object({
  runtimeInMs: z.lazy(() => SortOrderSchema).optional(),
  memoryUsedInKb: z.lazy(() => SortOrderSchema).optional()
}).strict();
...
export const ResourceCreatefieldsInputSchema: z.ZodType<Prisma.ResourceCreatefieldsInput> = z.object({
  set: z.string().array()
}).strict();

export const ResourceUpdatefieldsInputSchema: z.ZodType<Prisma.ResourceUpdatefieldsInput> = z.object({
  set: z.string().array().optional(),
  push: z.union([ z.string(),z.string().array() ]).optional(),
}).strict();

export const ProblemLanguageCreateNestedManyWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageCreateNestedManyWithoutLanguageInput> = z.object({
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema).array(),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProblemLanguageCreateOrConnectWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageCreateOrConnectWithoutLanguageInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProblemLanguageCreateManyLanguageInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const ProblemLanguageUncheckedCreateNestedManyWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedCreateNestedManyWithoutLanguageInput> = z.object({
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema).array(),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProblemLanguageCreateOrConnectWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageCreateOrConnectWithoutLanguageInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProblemLanguageCreateManyLanguageInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
...
export const ProblemLanguageUpdateManyWithoutLanguageNestedInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateManyWithoutLanguageNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema).array(),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProblemLanguageCreateOrConnectWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageCreateOrConnectWithoutLanguageInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProblemLanguageUpsertWithWhereUniqueWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUpsertWithWhereUniqueWithoutLanguageInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProblemLanguageCreateManyLanguageInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ProblemLanguageUpdateWithWhereUniqueWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUpdateWithWhereUniqueWithoutLanguageInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProblemLanguageUpdateManyWithWhereWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUpdateManyWithWhereWithoutLanguageInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ProblemLanguageScalarWhereInputSchema),z.lazy(() => ProblemLanguageScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const ProblemLanguageUncheckedUpdateManyWithoutLanguageNestedInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedUpdateManyWithoutLanguageNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema).array(),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProblemLanguageCreateOrConnectWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageCreateOrConnectWithoutLanguageInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProblemLanguageUpsertWithWhereUniqueWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUpsertWithWhereUniqueWithoutLanguageInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProblemLanguageCreateManyLanguageInputEnvelopeSchema).optional(),
...
export const ProblemLanguageCreateNestedManyWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageCreateNestedManyWithoutProblemInput> = z.object({
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema).array(),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProblemLanguageCreateOrConnectWithoutProblemInputSchema),z.lazy(() => ProblemLanguageCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProblemLanguageCreateManyProblemInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
}).strict();
...
export const SubmissionTestcaseCreateNestedManyWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateNestedManyWithoutProblemInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema).array(),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubmissionTestcaseCreateManyProblemInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const TestcaseCreateNestedManyWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseCreateNestedManyWithoutProblemInput> = z.object({
  create: z.union([ z.lazy(() => TestcaseCreateWithoutProblemInputSchema),z.lazy(() => TestcaseCreateWithoutProblemInputSchema).array(),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TestcaseCreateOrConnectWithoutProblemInputSchema),z.lazy(() => TestcaseCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TestcaseCreateManyProblemInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => TestcaseWhereUniqueInputSchema),z.lazy(() => TestcaseWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const ProblemLanguageUncheckedCreateNestedManyWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedCreateNestedManyWithoutProblemInput> = z.object({
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema).array(),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProblemLanguageCreateOrConnectWithoutProblemInputSchema),z.lazy(() => ProblemLanguageCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProblemLanguageCreateManyProblemInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
...
export const SubmissionTestcaseUncheckedCreateNestedManyWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedCreateNestedManyWithoutProblemInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema).array(),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubmissionTestcaseCreateManyProblemInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
...
export const TestcaseUncheckedCreateNestedManyWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseUncheckedCreateNestedManyWithoutProblemInput> = z.object({
  create: z.union([ z.lazy(() => TestcaseCreateWithoutProblemInputSchema),z.lazy(() => TestcaseCreateWithoutProblemInputSchema).array(),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TestcaseCreateOrConnectWithoutProblemInputSchema),z.lazy(() => TestcaseCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TestcaseCreateManyProblemInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => TestcaseWhereUniqueInputSchema),z.lazy(() => TestcaseWhereUniqueInputSchema).array() ]).optional(),
...
export const ProblemLanguageUpdateManyWithoutProblemNestedInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateManyWithoutProblemNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema).array(),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProblemLanguageCreateOrConnectWithoutProblemInputSchema),z.lazy(() => ProblemLanguageCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProblemLanguageUpsertWithWhereUniqueWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUpsertWithWhereUniqueWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProblemLanguageCreateManyProblemInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => ProblemLanguageWhereUniqueInputSchema),z.lazy(() => ProblemLanguageWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => ProblemLanguageUpdateWithWhereUniqueWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUpdateWithWhereUniqueWithoutProblemInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => ProblemLanguageUpdateManyWithWhereWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUpdateManyWithWhereWithoutProblemInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => ProblemLanguageScalarWhereInputSchema),z.lazy(() => ProblemLanguageScalarWhereInputSchema).array() ]).optional(),
}).strict();
...
export const SubmissionTestcaseUpdateManyWithoutProblemNestedInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateManyWithoutProblemNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema).array(),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SubmissionTestcaseUpsertWithWhereUniqueWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUpsertWithWhereUniqueWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubmissionTestcaseCreateManyProblemInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => SubmissionTestcaseUpdateWithWhereUniqueWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUpdateWithWhereUniqueWithoutProblemInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => SubmissionTestcaseUpdateManyWithWhereWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUpdateManyWithWhereWithoutProblemInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => SubmissionTestcaseScalarWhereInputSchema),z.lazy(() => SubmissionTestcaseScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const TestcaseUpdateManyWithoutProblemNestedInputSchema: z.ZodType<Prisma.TestcaseUpdateManyWithoutProblemNestedInput> = z.object({
  create: z.union([ z.lazy(() => TestcaseCreateWithoutProblemInputSchema),z.lazy(() => TestcaseCreateWithoutProblemInputSchema).array(),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TestcaseCreateOrConnectWithoutProblemInputSchema),z.lazy(() => TestcaseCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => TestcaseUpsertWithWhereUniqueWithoutProblemInputSchema),z.lazy(() => TestcaseUpsertWithWhereUniqueWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TestcaseCreateManyProblemInputEnvelopeSchema).optional(),
  ...
  connect: z.union([ z.lazy(() => TestcaseWhereUniqueInputSchema),z.lazy(() => TestcaseWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => TestcaseUpdateWithWhereUniqueWithoutProblemInputSchema),z.lazy(() => TestcaseUpdateWithWhereUniqueWithoutProblemInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => TestcaseUpdateManyWithWhereWithoutProblemInputSchema),z.lazy(() => TestcaseUpdateManyWithWhereWithoutProblemInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => TestcaseScalarWhereInputSchema),z.lazy(() => TestcaseScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const ProblemLanguageUncheckedUpdateManyWithoutProblemNestedInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedUpdateManyWithoutProblemNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema).array(),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => ProblemLanguageCreateOrConnectWithoutProblemInputSchema),z.lazy(() => ProblemLanguageCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => ProblemLanguageUpsertWithWhereUniqueWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUpsertWithWhereUniqueWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => ProblemLanguageCreateManyProblemInputEnvelopeSchema).optional(),
...
export const SubmissionTestcaseUncheckedUpdateManyWithoutProblemNestedInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedUpdateManyWithoutProblemNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema).array(),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SubmissionTestcaseUpsertWithWhereUniqueWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUpsertWithWhereUniqueWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubmissionTestcaseCreateManyProblemInputEnvelopeSchema).optional(),
...
export const TestcaseUncheckedUpdateManyWithoutProblemNestedInputSchema: z.ZodType<Prisma.TestcaseUncheckedUpdateManyWithoutProblemNestedInput> = z.object({
  create: z.union([ z.lazy(() => TestcaseCreateWithoutProblemInputSchema),z.lazy(() => TestcaseCreateWithoutProblemInputSchema).array(),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => TestcaseCreateOrConnectWithoutProblemInputSchema),z.lazy(() => TestcaseCreateOrConnectWithoutProblemInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => TestcaseUpsertWithWhereUniqueWithoutProblemInputSchema),z.lazy(() => TestcaseUpsertWithWhereUniqueWithoutProblemInputSchema).array() ]).optional(),
  createMany: z.lazy(() => TestcaseCreateManyProblemInputEnvelopeSchema).optional(),
...
export const LanguageCreateNestedOneWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.LanguageCreateNestedOneWithoutProblemLanguagesInput> = z.object({
  create: z.union([ z.lazy(() => LanguageCreateWithoutProblemLanguagesInputSchema),z.lazy(() => LanguageUncheckedCreateWithoutProblemLanguagesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => LanguageCreateOrConnectWithoutProblemLanguagesInputSchema).optional(),
  connect: z.lazy(() => LanguageWhereUniqueInputSchema).optional()
}).strict();

export const ProblemCreateNestedOneWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.ProblemCreateNestedOneWithoutProblemLanguagesInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutProblemLanguagesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutProblemLanguagesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutProblemLanguagesInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional()
}).strict();

export const LanguageUpdateOneRequiredWithoutProblemLanguagesNestedInputSchema: z.ZodType<Prisma.LanguageUpdateOneRequiredWithoutProblemLanguagesNestedInput> = z.object({
  create: z.union([ z.lazy(() => LanguageCreateWithoutProblemLanguagesInputSchema),z.lazy(() => LanguageUncheckedCreateWithoutProblemLanguagesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => LanguageCreateOrConnectWithoutProblemLanguagesInputSchema).optional(),
  upsert: z.lazy(() => LanguageUpsertWithoutProblemLanguagesInputSchema).optional(),
  connect: z.lazy(() => LanguageWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => LanguageUpdateToOneWithWhereWithoutProblemLanguagesInputSchema),z.lazy(() => LanguageUpdateWithoutProblemLanguagesInputSchema),z.lazy(() => LanguageUncheckedUpdateWithoutProblemLanguagesInputSchema) ]).optional(),
}).strict();

export const ProblemUpdateOneRequiredWithoutProblemLanguagesNestedInputSchema: z.ZodType<Prisma.ProblemUpdateOneRequiredWithoutProblemLanguagesNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutProblemLanguagesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutProblemLanguagesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutProblemLanguagesInputSchema).optional(),
  upsert: z.lazy(() => ProblemUpsertWithoutProblemLanguagesInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => ProblemUpdateToOneWithWhereWithoutProblemLanguagesInputSchema),z.lazy(() => ProblemUpdateWithoutProblemLanguagesInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutProblemLanguagesInputSchema) ]).optional(),
}).strict();

export const ProblemCreateNestedOneWithoutProblemTagsInputSchema: z.ZodType<Prisma.ProblemCreateNestedOneWithoutProblemTagsInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutProblemTagsInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutProblemTagsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutProblemTagsInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional()
}).strict();

export const TagCreateNestedOneWithoutProblemTagsInputSchema: z.ZodType<Prisma.TagCreateNestedOneWithoutProblemTagsInput> = z.object({
  create: z.union([ z.lazy(() => TagCreateWithoutProblemTagsInputSchema),z.lazy(() => TagUncheckedCreateWithoutProblemTagsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => TagCreateOrConnectWithoutProblemTagsInputSchema).optional(),
  connect: z.lazy(() => TagWhereUniqueInputSchema).optional()
}).strict();

export const ProblemUpdateOneRequiredWithoutProblemTagsNestedInputSchema: z.ZodType<Prisma.ProblemUpdateOneRequiredWithoutProblemTagsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutProblemTagsInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutProblemTagsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutProblemTagsInputSchema).optional(),
  upsert: z.lazy(() => ProblemUpsertWithoutProblemTagsInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => ProblemUpdateToOneWithWhereWithoutProblemTagsInputSchema),z.lazy(() => ProblemUpdateWithoutProblemTagsInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutProblemTagsInputSchema) ]).optional(),
}).strict();

export const TagUpdateOneRequiredWithoutProblemTagsNestedInputSchema: z.ZodType<Prisma.TagUpdateOneRequiredWithoutProblemTagsNestedInput> = z.object({
  create: z.union([ z.lazy(() => TagCreateWithoutProblemTagsInputSchema),z.lazy(() => TagUncheckedCreateWithoutProblemTagsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => TagCreateOrConnectWithoutProblemTagsInputSchema).optional(),
  upsert: z.lazy(() => TagUpsertWithoutProblemTagsInputSchema).optional(),
  connect: z.lazy(() => TagWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => TagUpdateToOneWithWhereWithoutProblemTagsInputSchema),z.lazy(() => TagUpdateWithoutProblemTagsInputSchema),z.lazy(() => TagUncheckedUpdateWithoutProblemTagsInputSchema) ]).optional(),
}).strict();

export const ProblemCreateNestedOneWithoutSubmissionsInputSchema: z.ZodType<Prisma.ProblemCreateNestedOneWithoutSubmissionsInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutSubmissionsInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutSubmissionsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutSubmissionsInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional()
}).strict();

export const SubmissionTestcaseCreateNestedManyWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateNestedManyWithoutSubmissionInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema).array(),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutSubmissionInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubmissionTestcaseCreateManySubmissionInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
}).strict();

export const SubmissionTestcaseUncheckedCreateNestedManyWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedCreateNestedManyWithoutSubmissionInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema).array(),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutSubmissionInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubmissionTestcaseCreateManySubmissionInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
...
export const ProblemUpdateOneRequiredWithoutSubmissionsNestedInputSchema: z.ZodType<Prisma.ProblemUpdateOneRequiredWithoutSubmissionsNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutSubmissionsInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutSubmissionsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutSubmissionsInputSchema).optional(),
  upsert: z.lazy(() => ProblemUpsertWithoutSubmissionsInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => ProblemUpdateToOneWithWhereWithoutSubmissionsInputSchema),z.lazy(() => ProblemUpdateWithoutSubmissionsInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutSubmissionsInputSchema) ]).optional(),
}).strict();

export const SubmissionTestcaseUpdateManyWithoutSubmissionNestedInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateManyWithoutSubmissionNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema).array(),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutSubmissionInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SubmissionTestcaseUpsertWithWhereUniqueWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUpsertWithWhereUniqueWithoutSubmissionInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubmissionTestcaseCreateManySubmissionInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => SubmissionTestcaseUpdateWithWhereUniqueWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUpdateWithWhereUniqueWithoutSubmissionInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => SubmissionTestcaseUpdateManyWithWhereWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUpdateManyWithWhereWithoutSubmissionInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => SubmissionTestcaseScalarWhereInputSchema),z.lazy(() => SubmissionTestcaseScalarWhereInputSchema).array() ]).optional(),
}).strict();

export const SubmissionTestcaseUncheckedUpdateManyWithoutSubmissionNestedInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedUpdateManyWithoutSubmissionNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema).array(),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseCreateOrConnectWithoutSubmissionInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => SubmissionTestcaseUpsertWithWhereUniqueWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUpsertWithWhereUniqueWithoutSubmissionInputSchema).array() ]).optional(),
  createMany: z.lazy(() => SubmissionTestcaseCreateManySubmissionInputEnvelopeSchema).optional(),
...
export const ProblemCreateNestedOneWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.ProblemCreateNestedOneWithoutSubmissionTestcasesInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutSubmissionTestcasesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutSubmissionTestcasesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutSubmissionTestcasesInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional()
}).strict();

export const SubmissionCreateNestedOneWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.SubmissionCreateNestedOneWithoutSubmissionTestcasesInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionCreateWithoutSubmissionTestcasesInputSchema),z.lazy(() => SubmissionUncheckedCreateWithoutSubmissionTestcasesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SubmissionCreateOrConnectWithoutSubmissionTestcasesInputSchema).optional(),
  connect: z.lazy(() => SubmissionWhereUniqueInputSchema).optional()
}).strict();

export const ProblemUpdateOneRequiredWithoutSubmissionTestcasesNestedInputSchema: z.ZodType<Prisma.ProblemUpdateOneRequiredWithoutSubmissionTestcasesNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutSubmissionTestcasesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutSubmissionTestcasesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutSubmissionTestcasesInputSchema).optional(),
  upsert: z.lazy(() => ProblemUpsertWithoutSubmissionTestcasesInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => ProblemUpdateToOneWithWhereWithoutSubmissionTestcasesInputSchema),z.lazy(() => ProblemUpdateWithoutSubmissionTestcasesInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutSubmissionTestcasesInputSchema) ]).optional(),
}).strict();

export const SubmissionUpdateOneRequiredWithoutSubmissionTestcasesNestedInputSchema: z.ZodType<Prisma.SubmissionUpdateOneRequiredWithoutSubmissionTestcasesNestedInput> = z.object({
  create: z.union([ z.lazy(() => SubmissionCreateWithoutSubmissionTestcasesInputSchema),z.lazy(() => SubmissionUncheckedCreateWithoutSubmissionTestcasesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SubmissionCreateOrConnectWithoutSubmissionTestcasesInputSchema).optional(),
  upsert: z.lazy(() => SubmissionUpsertWithoutSubmissionTestcasesInputSchema).optional(),
  connect: z.lazy(() => SubmissionWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SubmissionUpdateToOneWithWhereWithoutSubmissionTestcasesInputSchema),z.lazy(() => SubmissionUpdateWithoutSubmissionTestcasesInputSchema),z.lazy(() => SubmissionUncheckedUpdateWithoutSubmissionTestcasesInputSchema) ]).optional(),
}).strict();
...
export const ProblemCreateNestedOneWithoutTestcasesInputSchema: z.ZodType<Prisma.ProblemCreateNestedOneWithoutTestcasesInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutTestcasesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutTestcasesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutTestcasesInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional()
}).strict();

export const ProblemUpdateOneRequiredWithoutTestcasesNestedInputSchema: z.ZodType<Prisma.ProblemUpdateOneRequiredWithoutTestcasesNestedInput> = z.object({
  create: z.union([ z.lazy(() => ProblemCreateWithoutTestcasesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutTestcasesInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => ProblemCreateOrConnectWithoutTestcasesInputSchema).optional(),
  upsert: z.lazy(() => ProblemUpsertWithoutTestcasesInputSchema).optional(),
  connect: z.lazy(() => ProblemWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => ProblemUpdateToOneWithWhereWithoutTestcasesInputSchema),z.lazy(() => ProblemUpdateWithoutTestcasesInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutTestcasesInputSchema) ]).optional(),
}).strict();
...
export const ProblemLanguageCreateWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageCreateWithoutLanguageInput> = z.object({
  templateCode: z.string().optional().nullable(),
  timeLimitInMs: z.number().int().optional(),
  memoryLimitInKb: z.number().int().optional(),
  problem: z.lazy(() => ProblemCreateNestedOneWithoutProblemLanguagesInputSchema)
...
export const ProblemLanguageUncheckedCreateWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedCreateWithoutLanguageInput> = z.object({
  problemId: z.string(),
  templateCode: z.string().optional().nullable(),
  timeLimitInMs: z.number().int().optional(),
  memoryLimitInKb: z.number().int().optional()
...
export const ProblemLanguageCreateOrConnectWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageCreateOrConnectWithoutLanguageInput> = z.object({
  where: z.lazy(() => ProblemLanguageWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema) ]),
}).strict();

export const ProblemLanguageCreateManyLanguageInputEnvelopeSchema: z.ZodType<Prisma.ProblemLanguageCreateManyLanguageInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => ProblemLanguageCreateManyLanguageInputSchema),z.lazy(() => ProblemLanguageCreateManyLanguageInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();

export const ProblemLanguageUpsertWithWhereUniqueWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageUpsertWithWhereUniqueWithoutLanguageInput> = z.object({
  where: z.lazy(() => ProblemLanguageWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProblemLanguageUpdateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUncheckedUpdateWithoutLanguageInputSchema) ]),
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutLanguageInputSchema) ]),
}).strict();

export const ProblemLanguageUpdateWithWhereUniqueWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateWithWhereUniqueWithoutLanguageInput> = z.object({
  where: z.lazy(() => ProblemLanguageWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProblemLanguageUpdateWithoutLanguageInputSchema),z.lazy(() => ProblemLanguageUncheckedUpdateWithoutLanguageInputSchema) ]),
}).strict();

export const ProblemLanguageUpdateManyWithWhereWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateManyWithWhereWithoutLanguageInput> = z.object({
  where: z.lazy(() => ProblemLanguageScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ProblemLanguageUpdateManyMutationInputSchema),z.lazy(() => ProblemLanguageUncheckedUpdateManyWithoutLanguageInputSchema) ]),
}).strict();

export const ProblemLanguageScalarWhereInputSchema: z.ZodType<Prisma.ProblemLanguageScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => ProblemLanguageScalarWhereInputSchema),z.lazy(() => ProblemLanguageScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => ProblemLanguageScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => ProblemLanguageScalarWhereInputSchema),z.lazy(() => ProblemLanguageScalarWhereInputSchema).array() ]).optional(),
  problemId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  languageId: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
  templateCode: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
  timeLimitInMs: z.union([ z.lazy(() => IntFilterSchema),z.number() ]).optional(),
...
export const ProblemLanguageCreateWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageCreateWithoutProblemInput> = z.object({
  templateCode: z.string().optional().nullable(),
  timeLimitInMs: z.number().int().optional(),
  memoryLimitInKb: z.number().int().optional(),
  language: z.lazy(() => LanguageCreateNestedOneWithoutProblemLanguagesInputSchema)
...
export const ProblemLanguageUncheckedCreateWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedCreateWithoutProblemInput> = z.object({
  languageId: z.number().int(),
  templateCode: z.string().optional().nullable(),
  timeLimitInMs: z.number().int().optional(),
  memoryLimitInKb: z.number().int().optional()
...
export const ProblemLanguageCreateOrConnectWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageCreateOrConnectWithoutProblemInput> = z.object({
  where: z.lazy(() => ProblemLanguageWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema) ]),
}).strict();

export const ProblemLanguageCreateManyProblemInputEnvelopeSchema: z.ZodType<Prisma.ProblemLanguageCreateManyProblemInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => ProblemLanguageCreateManyProblemInputSchema),z.lazy(() => ProblemLanguageCreateManyProblemInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();
...
export const SubmissionTestcaseCreateWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateWithoutProblemInput> = z.object({
  testcaseId: z.string(),
  status: z.string(),
  stdout: z.string().optional().nullable(),
  runtimeInMs: z.number().int().optional(),
...
export const SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedCreateWithoutProblemInput> = z.object({
  submissionId: z.string(),
  testcaseId: z.string(),
  status: z.string(),
  stdout: z.string().optional().nullable(),
...
export const SubmissionTestcaseCreateOrConnectWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateOrConnectWithoutProblemInput> = z.object({
  where: z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema) ]),
}).strict();

export const SubmissionTestcaseCreateManyProblemInputEnvelopeSchema: z.ZodType<Prisma.SubmissionTestcaseCreateManyProblemInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => SubmissionTestcaseCreateManyProblemInputSchema),z.lazy(() => SubmissionTestcaseCreateManyProblemInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();

export const TestcaseCreateWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseCreateWithoutProblemInput> = z.object({
  testCaseId: z.string().optional(),
  inputData: z.string(),
  expectedOutput: z.string(),
  isSample: z.boolean().optional(),
...
export const TestcaseUncheckedCreateWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseUncheckedCreateWithoutProblemInput> = z.object({
  testCaseId: z.string().optional(),
  inputData: z.string(),
  expectedOutput: z.string(),
  isSample: z.boolean().optional(),
...
export const TestcaseCreateOrConnectWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseCreateOrConnectWithoutProblemInput> = z.object({
  where: z.lazy(() => TestcaseWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => TestcaseCreateWithoutProblemInputSchema),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema) ]),
}).strict();

export const TestcaseCreateManyProblemInputEnvelopeSchema: z.ZodType<Prisma.TestcaseCreateManyProblemInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => TestcaseCreateManyProblemInputSchema),z.lazy(() => TestcaseCreateManyProblemInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();

export const ProblemLanguageUpsertWithWhereUniqueWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageUpsertWithWhereUniqueWithoutProblemInput> = z.object({
  where: z.lazy(() => ProblemLanguageWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => ProblemLanguageUpdateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUncheckedUpdateWithoutProblemInputSchema) ]),
  create: z.union([ z.lazy(() => ProblemLanguageCreateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUncheckedCreateWithoutProblemInputSchema) ]),
}).strict();

export const ProblemLanguageUpdateWithWhereUniqueWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateWithWhereUniqueWithoutProblemInput> = z.object({
  where: z.lazy(() => ProblemLanguageWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => ProblemLanguageUpdateWithoutProblemInputSchema),z.lazy(() => ProblemLanguageUncheckedUpdateWithoutProblemInputSchema) ]),
}).strict();

export const ProblemLanguageUpdateManyWithWhereWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateManyWithWhereWithoutProblemInput> = z.object({
  where: z.lazy(() => ProblemLanguageScalarWhereInputSchema),
  data: z.union([ z.lazy(() => ProblemLanguageUpdateManyMutationInputSchema),z.lazy(() => ProblemLanguageUncheckedUpdateManyWithoutProblemInputSchema) ]),
}).strict();
...
export const SubmissionUpdateManyWithWhereWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionUpdateManyWithWhereWithoutProblemInput> = z.object({
  ...
  data: z.union([ z.lazy(() => SubmissionUpdateManyMutationInputSchema),z.lazy(() => SubmissionUncheckedUpdateManyWithoutProblemInputSchema) ]),
}).strict();
...
export const SubmissionTestcaseUpsertWithWhereUniqueWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpsertWithWhereUniqueWithoutProblemInput> = z.object({
  where: z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => SubmissionTestcaseUpdateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUncheckedUpdateWithoutProblemInputSchema) ]),
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutProblemInputSchema) ]),
}).strict();

export const SubmissionTestcaseUpdateWithWhereUniqueWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateWithWhereUniqueWithoutProblemInput> = z.object({
  where: z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => SubmissionTestcaseUpdateWithoutProblemInputSchema),z.lazy(() => SubmissionTestcaseUncheckedUpdateWithoutProblemInputSchema) ]),
}).strict();

export const SubmissionTestcaseUpdateManyWithWhereWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateManyWithWhereWithoutProblemInput> = z.object({
  where: z.lazy(() => SubmissionTestcaseScalarWhereInputSchema),
  data: z.union([ z.lazy(() => SubmissionTestcaseUpdateManyMutationInputSchema),z.lazy(() => SubmissionTestcaseUncheckedUpdateManyWithoutProblemInputSchema) ]),
}).strict();

export const SubmissionTestcaseScalarWhereInputSchema: z.ZodType<Prisma.SubmissionTestcaseScalarWhereInput> = z.object({
  AND: z.union([ z.lazy(() => SubmissionTestcaseScalarWhereInputSchema),z.lazy(() => SubmissionTestcaseScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => SubmissionTestcaseScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => SubmissionTestcaseScalarWhereInputSchema),z.lazy(() => SubmissionTestcaseScalarWhereInputSchema).array() ]).optional(),
  submissionId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  testcaseId: z.union([ z.lazy(() => UuidFilterSchema),z.string() ]).optional(),
  status: z.union([ z.lazy(() => StringFilterSchema),z.string() ]).optional(),
  stdout: z.union([ z.lazy(() => StringNullableFilterSchema),z.string() ]).optional().nullable(),
...
export const TestcaseUpsertWithWhereUniqueWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseUpsertWithWhereUniqueWithoutProblemInput> = z.object({
  where: z.lazy(() => TestcaseWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => TestcaseUpdateWithoutProblemInputSchema),z.lazy(() => TestcaseUncheckedUpdateWithoutProblemInputSchema) ]),
  create: z.union([ z.lazy(() => TestcaseCreateWithoutProblemInputSchema),z.lazy(() => TestcaseUncheckedCreateWithoutProblemInputSchema) ]),
}).strict();

export const TestcaseUpdateWithWhereUniqueWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseUpdateWithWhereUniqueWithoutProblemInput> = z.object({
  where: z.lazy(() => TestcaseWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => TestcaseUpdateWithoutProblemInputSchema),z.lazy(() => TestcaseUncheckedUpdateWithoutProblemInputSchema) ]),
}).strict();

export const TestcaseUpdateManyWithWhereWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseUpdateManyWithWhereWithoutProblemInput> = z.object({
  where: z.lazy(() => TestcaseScalarWhereInputSchema),
  data: z.union([ z.lazy(() => TestcaseUpdateManyMutationInputSchema),z.lazy(() => TestcaseUncheckedUpdateManyWithoutProblemInputSchema) ]),
}).strict();
...
export const LanguageCreateWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.LanguageCreateWithoutProblemLanguagesInput> = z.object({
  languageName: z.string(),
  version: z.string(),
  sourceFileExt: z.string(),
  binaryFileExt: z.string().optional().nullable(),
...
export const LanguageUncheckedCreateWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.LanguageUncheckedCreateWithoutProblemLanguagesInput> = z.object({
  languageId: z.number().int().optional(),
  languageName: z.string(),
  version: z.string(),
  sourceFileExt: z.string(),
...
export const LanguageCreateOrConnectWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.LanguageCreateOrConnectWithoutProblemLanguagesInput> = z.object({
  where: z.lazy(() => LanguageWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => LanguageCreateWithoutProblemLanguagesInputSchema),z.lazy(() => LanguageUncheckedCreateWithoutProblemLanguagesInputSchema) ]),
}).strict();

export const ProblemCreateWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.ProblemCreateWithoutProblemLanguagesInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemUncheckedCreateWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.ProblemUncheckedCreateWithoutProblemLanguagesInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemCreateOrConnectWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.ProblemCreateOrConnectWithoutProblemLanguagesInput> = z.object({
  where: z.lazy(() => ProblemWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ProblemCreateWithoutProblemLanguagesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutProblemLanguagesInputSchema) ]),
}).strict();

export const LanguageUpsertWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.LanguageUpsertWithoutProblemLanguagesInput> = z.object({
  update: z.union([ z.lazy(() => LanguageUpdateWithoutProblemLanguagesInputSchema),z.lazy(() => LanguageUncheckedUpdateWithoutProblemLanguagesInputSchema) ]),
  create: z.union([ z.lazy(() => LanguageCreateWithoutProblemLanguagesInputSchema),z.lazy(() => LanguageUncheckedCreateWithoutProblemLanguagesInputSchema) ]),
  where: z.lazy(() => LanguageWhereInputSchema).optional()
}).strict();

export const LanguageUpdateToOneWithWhereWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.LanguageUpdateToOneWithWhereWithoutProblemLanguagesInput> = z.object({
  where: z.lazy(() => LanguageWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => LanguageUpdateWithoutProblemLanguagesInputSchema),z.lazy(() => LanguageUncheckedUpdateWithoutProblemLanguagesInputSchema) ]),
}).strict();

export const LanguageUpdateWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.LanguageUpdateWithoutProblemLanguagesInput> = z.object({
  languageName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  version: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  sourceFileExt: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  binaryFileExt: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const LanguageUncheckedUpdateWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.LanguageUncheckedUpdateWithoutProblemLanguagesInput> = z.object({
  languageId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  languageName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  version: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  sourceFileExt: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProblemUpsertWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.ProblemUpsertWithoutProblemLanguagesInput> = z.object({
  update: z.union([ z.lazy(() => ProblemUpdateWithoutProblemLanguagesInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutProblemLanguagesInputSchema) ]),
  create: z.union([ z.lazy(() => ProblemCreateWithoutProblemLanguagesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutProblemLanguagesInputSchema) ]),
  where: z.lazy(() => ProblemWhereInputSchema).optional()
}).strict();

export const ProblemUpdateToOneWithWhereWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.ProblemUpdateToOneWithWhereWithoutProblemLanguagesInput> = z.object({
  where: z.lazy(() => ProblemWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ProblemUpdateWithoutProblemLanguagesInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutProblemLanguagesInputSchema) ]),
}).strict();

export const ProblemUpdateWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.ProblemUpdateWithoutProblemLanguagesInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const ProblemUncheckedUpdateWithoutProblemLanguagesInputSchema: z.ZodType<Prisma.ProblemUncheckedUpdateWithoutProblemLanguagesInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const ProblemCreateWithoutProblemTagsInputSchema: z.ZodType<Prisma.ProblemCreateWithoutProblemTagsInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemUncheckedCreateWithoutProblemTagsInputSchema: z.ZodType<Prisma.ProblemUncheckedCreateWithoutProblemTagsInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemCreateOrConnectWithoutProblemTagsInputSchema: z.ZodType<Prisma.ProblemCreateOrConnectWithoutProblemTagsInput> = z.object({
  where: z.lazy(() => ProblemWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ProblemCreateWithoutProblemTagsInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutProblemTagsInputSchema) ]),
}).strict();

export const TagCreateWithoutProblemTagsInputSchema: z.ZodType<Prisma.TagCreateWithoutProblemTagsInput> = z.object({
  tagId: z.string().optional(),
  tagName: z.string(),
  description: z.string().optional().nullable(),
  createdAt: z.coerce.date().optional(),
...
export const TagUncheckedCreateWithoutProblemTagsInputSchema: z.ZodType<Prisma.TagUncheckedCreateWithoutProblemTagsInput> = z.object({
  tagId: z.string().optional(),
  tagName: z.string(),
  description: z.string().optional().nullable(),
  createdAt: z.coerce.date().optional(),
...
export const TagCreateOrConnectWithoutProblemTagsInputSchema: z.ZodType<Prisma.TagCreateOrConnectWithoutProblemTagsInput> = z.object({
  where: z.lazy(() => TagWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => TagCreateWithoutProblemTagsInputSchema),z.lazy(() => TagUncheckedCreateWithoutProblemTagsInputSchema) ]),
}).strict();

export const ProblemUpsertWithoutProblemTagsInputSchema: z.ZodType<Prisma.ProblemUpsertWithoutProblemTagsInput> = z.object({
  update: z.union([ z.lazy(() => ProblemUpdateWithoutProblemTagsInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutProblemTagsInputSchema) ]),
  create: z.union([ z.lazy(() => ProblemCreateWithoutProblemTagsInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutProblemTagsInputSchema) ]),
  where: z.lazy(() => ProblemWhereInputSchema).optional()
}).strict();

export const ProblemUpdateToOneWithWhereWithoutProblemTagsInputSchema: z.ZodType<Prisma.ProblemUpdateToOneWithWhereWithoutProblemTagsInput> = z.object({
  where: z.lazy(() => ProblemWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ProblemUpdateWithoutProblemTagsInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutProblemTagsInputSchema) ]),
}).strict();

export const ProblemUpdateWithoutProblemTagsInputSchema: z.ZodType<Prisma.ProblemUpdateWithoutProblemTagsInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const ProblemUncheckedUpdateWithoutProblemTagsInputSchema: z.ZodType<Prisma.ProblemUncheckedUpdateWithoutProblemTagsInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const TagUpsertWithoutProblemTagsInputSchema: z.ZodType<Prisma.TagUpsertWithoutProblemTagsInput> = z.object({
  update: z.union([ z.lazy(() => TagUpdateWithoutProblemTagsInputSchema),z.lazy(() => TagUncheckedUpdateWithoutProblemTagsInputSchema) ]),
  create: z.union([ z.lazy(() => TagCreateWithoutProblemTagsInputSchema),z.lazy(() => TagUncheckedCreateWithoutProblemTagsInputSchema) ]),
  where: z.lazy(() => TagWhereInputSchema).optional()
}).strict();

export const TagUpdateToOneWithWhereWithoutProblemTagsInputSchema: z.ZodType<Prisma.TagUpdateToOneWithWhereWithoutProblemTagsInput> = z.object({
  where: z.lazy(() => TagWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => TagUpdateWithoutProblemTagsInputSchema),z.lazy(() => TagUncheckedUpdateWithoutProblemTagsInputSchema) ]),
}).strict();

export const TagUpdateWithoutProblemTagsInputSchema: z.ZodType<Prisma.TagUpdateWithoutProblemTagsInput> = z.object({
  tagId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  tagName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const TagUncheckedUpdateWithoutProblemTagsInputSchema: z.ZodType<Prisma.TagUncheckedUpdateWithoutProblemTagsInput> = z.object({
  tagId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  tagName: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProblemCreateWithoutSubmissionsInputSchema: z.ZodType<Prisma.ProblemCreateWithoutSubmissionsInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemUncheckedCreateWithoutSubmissionsInputSchema: z.ZodType<Prisma.ProblemUncheckedCreateWithoutSubmissionsInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemCreateOrConnectWithoutSubmissionsInputSchema: z.ZodType<Prisma.ProblemCreateOrConnectWithoutSubmissionsInput> = z.object({
  where: z.lazy(() => ProblemWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ProblemCreateWithoutSubmissionsInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutSubmissionsInputSchema) ]),
}).strict();

export const SubmissionTestcaseCreateWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateWithoutSubmissionInput> = z.object({
  testcaseId: z.string(),
  status: z.string(),
  stdout: z.string().optional().nullable(),
  runtimeInMs: z.number().int().optional(),
...
export const SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedCreateWithoutSubmissionInput> = z.object({
  testcaseId: z.string(),
  status: z.string(),
  stdout: z.string().optional().nullable(),
  problemId: z.string(),
...
export const SubmissionTestcaseCreateOrConnectWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateOrConnectWithoutSubmissionInput> = z.object({
  where: z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema) ]),
}).strict();

export const SubmissionTestcaseCreateManySubmissionInputEnvelopeSchema: z.ZodType<Prisma.SubmissionTestcaseCreateManySubmissionInputEnvelope> = z.object({
  data: z.union([ z.lazy(() => SubmissionTestcaseCreateManySubmissionInputSchema),z.lazy(() => SubmissionTestcaseCreateManySubmissionInputSchema).array() ]),
  skipDuplicates: z.boolean().optional()
}).strict();

export const ProblemUpsertWithoutSubmissionsInputSchema: z.ZodType<Prisma.ProblemUpsertWithoutSubmissionsInput> = z.object({
  update: z.union([ z.lazy(() => ProblemUpdateWithoutSubmissionsInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutSubmissionsInputSchema) ]),
  create: z.union([ z.lazy(() => ProblemCreateWithoutSubmissionsInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutSubmissionsInputSchema) ]),
  where: z.lazy(() => ProblemWhereInputSchema).optional()
}).strict();

export const ProblemUpdateToOneWithWhereWithoutSubmissionsInputSchema: z.ZodType<Prisma.ProblemUpdateToOneWithWhereWithoutSubmissionsInput> = z.object({
  where: z.lazy(() => ProblemWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ProblemUpdateWithoutSubmissionsInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutSubmissionsInputSchema) ]),
}).strict();

export const ProblemUpdateWithoutSubmissionsInputSchema: z.ZodType<Prisma.ProblemUpdateWithoutSubmissionsInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const ProblemUncheckedUpdateWithoutSubmissionsInputSchema: z.ZodType<Prisma.ProblemUncheckedUpdateWithoutSubmissionsInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const SubmissionTestcaseUpsertWithWhereUniqueWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpsertWithWhereUniqueWithoutSubmissionInput> = z.object({
  where: z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => SubmissionTestcaseUpdateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUncheckedUpdateWithoutSubmissionInputSchema) ]),
  create: z.union([ z.lazy(() => SubmissionTestcaseCreateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUncheckedCreateWithoutSubmissionInputSchema) ]),
}).strict();

export const SubmissionTestcaseUpdateWithWhereUniqueWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateWithWhereUniqueWithoutSubmissionInput> = z.object({
  where: z.lazy(() => SubmissionTestcaseWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => SubmissionTestcaseUpdateWithoutSubmissionInputSchema),z.lazy(() => SubmissionTestcaseUncheckedUpdateWithoutSubmissionInputSchema) ]),
}).strict();

export const SubmissionTestcaseUpdateManyWithWhereWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateManyWithWhereWithoutSubmissionInput> = z.object({
  where: z.lazy(() => SubmissionTestcaseScalarWhereInputSchema),
  data: z.union([ z.lazy(() => SubmissionTestcaseUpdateManyMutationInputSchema),z.lazy(() => SubmissionTestcaseUncheckedUpdateManyWithoutSubmissionInputSchema) ]),
}).strict();

export const ProblemCreateWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.ProblemCreateWithoutSubmissionTestcasesInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemUncheckedCreateWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.ProblemUncheckedCreateWithoutSubmissionTestcasesInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemCreateOrConnectWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.ProblemCreateOrConnectWithoutSubmissionTestcasesInput> = z.object({
  where: z.lazy(() => ProblemWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ProblemCreateWithoutSubmissionTestcasesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutSubmissionTestcasesInputSchema) ]),
}).strict();

export const SubmissionCreateWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.SubmissionCreateWithoutSubmissionTestcasesInput> = z.object({
  submissionId: z.string().optional(),
  userId: z.string(),
  languageId: z.number().int(),
  code: z.string(),
...
export const SubmissionUncheckedCreateWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.SubmissionUncheckedCreateWithoutSubmissionTestcasesInput> = z.object({
  submissionId: z.string().optional(),
  userId: z.string(),
  problemId: z.string(),
  languageId: z.number().int(),
...
export const SubmissionCreateOrConnectWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.SubmissionCreateOrConnectWithoutSubmissionTestcasesInput> = z.object({
  where: z.lazy(() => SubmissionWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SubmissionCreateWithoutSubmissionTestcasesInputSchema),z.lazy(() => SubmissionUncheckedCreateWithoutSubmissionTestcasesInputSchema) ]),
}).strict();

export const ProblemUpsertWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.ProblemUpsertWithoutSubmissionTestcasesInput> = z.object({
  update: z.union([ z.lazy(() => ProblemUpdateWithoutSubmissionTestcasesInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutSubmissionTestcasesInputSchema) ]),
  create: z.union([ z.lazy(() => ProblemCreateWithoutSubmissionTestcasesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutSubmissionTestcasesInputSchema) ]),
  where: z.lazy(() => ProblemWhereInputSchema).optional()
}).strict();

export const ProblemUpdateToOneWithWhereWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.ProblemUpdateToOneWithWhereWithoutSubmissionTestcasesInput> = z.object({
  where: z.lazy(() => ProblemWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ProblemUpdateWithoutSubmissionTestcasesInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutSubmissionTestcasesInputSchema) ]),
}).strict();

export const ProblemUpdateWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.ProblemUpdateWithoutSubmissionTestcasesInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const ProblemUncheckedUpdateWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.ProblemUncheckedUpdateWithoutSubmissionTestcasesInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const SubmissionUpsertWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.SubmissionUpsertWithoutSubmissionTestcasesInput> = z.object({
  update: z.union([ z.lazy(() => SubmissionUpdateWithoutSubmissionTestcasesInputSchema),z.lazy(() => SubmissionUncheckedUpdateWithoutSubmissionTestcasesInputSchema) ]),
  create: z.union([ z.lazy(() => SubmissionCreateWithoutSubmissionTestcasesInputSchema),z.lazy(() => SubmissionUncheckedCreateWithoutSubmissionTestcasesInputSchema) ]),
  where: z.lazy(() => SubmissionWhereInputSchema).optional()
}).strict();

export const SubmissionUpdateToOneWithWhereWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.SubmissionUpdateToOneWithWhereWithoutSubmissionTestcasesInput> = z.object({
  where: z.lazy(() => SubmissionWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => SubmissionUpdateWithoutSubmissionTestcasesInputSchema),z.lazy(() => SubmissionUncheckedUpdateWithoutSubmissionTestcasesInputSchema) ]),
}).strict();

export const SubmissionUpdateWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.SubmissionUpdateWithoutSubmissionTestcasesInput> = z.object({
  submissionId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  userId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  languageId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  code: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubmissionUncheckedUpdateWithoutSubmissionTestcasesInputSchema: z.ZodType<Prisma.SubmissionUncheckedUpdateWithoutSubmissionTestcasesInput> = z.object({
  submissionId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  userId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  languageId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProblemCreateWithoutTestcasesInputSchema: z.ZodType<Prisma.ProblemCreateWithoutTestcasesInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemUncheckedCreateWithoutTestcasesInputSchema: z.ZodType<Prisma.ProblemUncheckedCreateWithoutTestcasesInput> = z.object({
  problemId: z.string().optional(),
  title: z.string(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]),
...
export const ProblemCreateOrConnectWithoutTestcasesInputSchema: z.ZodType<Prisma.ProblemCreateOrConnectWithoutTestcasesInput> = z.object({
  where: z.lazy(() => ProblemWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => ProblemCreateWithoutTestcasesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutTestcasesInputSchema) ]),
}).strict();

export const ProblemUpsertWithoutTestcasesInputSchema: z.ZodType<Prisma.ProblemUpsertWithoutTestcasesInput> = z.object({
  update: z.union([ z.lazy(() => ProblemUpdateWithoutTestcasesInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutTestcasesInputSchema) ]),
  create: z.union([ z.lazy(() => ProblemCreateWithoutTestcasesInputSchema),z.lazy(() => ProblemUncheckedCreateWithoutTestcasesInputSchema) ]),
  where: z.lazy(() => ProblemWhereInputSchema).optional()
}).strict();

export const ProblemUpdateToOneWithWhereWithoutTestcasesInputSchema: z.ZodType<Prisma.ProblemUpdateToOneWithWhereWithoutTestcasesInput> = z.object({
  where: z.lazy(() => ProblemWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => ProblemUpdateWithoutTestcasesInputSchema),z.lazy(() => ProblemUncheckedUpdateWithoutTestcasesInputSchema) ]),
}).strict();

export const ProblemUpdateWithoutTestcasesInputSchema: z.ZodType<Prisma.ProblemUpdateWithoutTestcasesInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const ProblemUncheckedUpdateWithoutTestcasesInputSchema: z.ZodType<Prisma.ProblemUncheckedUpdateWithoutTestcasesInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  title: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  description: z.union([ z.lazy(() => NullableJsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
  problemStatement: z.union([ z.lazy(() => JsonNullValueInputSchema),InputJsonValueSchema ]).optional(),
...
export const ProblemLanguageCreateManyLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageCreateManyLanguageInput> = z.object({
  problemId: z.string(),
  templateCode: z.string().optional().nullable(),
  timeLimitInMs: z.number().int().optional(),
  memoryLimitInKb: z.number().int().optional()
...
export const ProblemLanguageUpdateWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateWithoutLanguageInput> = z.object({
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryLimitInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  problem: z.lazy(() => ProblemUpdateOneRequiredWithoutProblemLanguagesNestedInputSchema).optional()
...
export const ProblemLanguageUncheckedUpdateWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedUpdateWithoutLanguageInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryLimitInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProblemLanguageUncheckedUpdateManyWithoutLanguageInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedUpdateManyWithoutLanguageInput> = z.object({
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryLimitInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProblemLanguageCreateManyProblemInputSchema: z.ZodType<Prisma.ProblemLanguageCreateManyProblemInput> = z.object({
  languageId: z.number().int(),
  templateCode: z.string().optional().nullable(),
  timeLimitInMs: z.number().int().optional(),
  memoryLimitInKb: z.number().int().optional()
...
export const SubmissionTestcaseCreateManyProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateManyProblemInput> = z.object({
  submissionId: z.string(),
  testcaseId: z.string(),
  status: z.string(),
  stdout: z.string().optional().nullable(),
...
export const TestcaseCreateManyProblemInputSchema: z.ZodType<Prisma.TestcaseCreateManyProblemInput> = z.object({
  testCaseId: z.string().optional(),
  inputData: z.string(),
  expectedOutput: z.string(),
  isSample: z.boolean().optional(),
...
export const ProblemLanguageUpdateWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageUpdateWithoutProblemInput> = z.object({
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryLimitInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  language: z.lazy(() => LanguageUpdateOneRequiredWithoutProblemLanguagesNestedInputSchema).optional()
...
export const ProblemLanguageUncheckedUpdateWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedUpdateWithoutProblemInput> = z.object({
  languageId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryLimitInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProblemLanguageUncheckedUpdateManyWithoutProblemInputSchema: z.ZodType<Prisma.ProblemLanguageUncheckedUpdateManyWithoutProblemInput> = z.object({
  languageId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  templateCode: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  timeLimitInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  memoryLimitInKb: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubmissionUncheckedUpdateManyWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionUncheckedUpdateManyWithoutProblemInput> = z.object({
  submissionId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  userId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  languageId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  code: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubmissionTestcaseUpdateWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateWithoutProblemInput> = z.object({
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  runtimeInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubmissionTestcaseUncheckedUpdateWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedUpdateWithoutProblemInput> = z.object({
  submissionId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SubmissionTestcaseUncheckedUpdateManyWithoutProblemInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedUpdateManyWithoutProblemInput> = z.object({
  submissionId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const TestcaseUpdateWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseUpdateWithoutProblemInput> = z.object({
  testCaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  inputData: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  expectedOutput: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  isSample: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
...
export const TestcaseUncheckedUpdateWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseUncheckedUpdateWithoutProblemInput> = z.object({
  testCaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  inputData: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  expectedOutput: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  isSample: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
...
export const TestcaseUncheckedUpdateManyWithoutProblemInputSchema: z.ZodType<Prisma.TestcaseUncheckedUpdateManyWithoutProblemInput> = z.object({
  testCaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  inputData: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  expectedOutput: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  isSample: z.union([ z.boolean(),z.lazy(() => BoolFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubmissionTestcaseCreateManySubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseCreateManySubmissionInput> = z.object({
  testcaseId: z.string(),
  status: z.string(),
  stdout: z.string().optional().nullable(),
  problemId: z.string(),
...
export const SubmissionTestcaseUpdateWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateWithoutSubmissionInput> = z.object({
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  runtimeInMs: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubmissionTestcaseUncheckedUpdateWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedUpdateWithoutSubmissionInput> = z.object({
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SubmissionTestcaseUncheckedUpdateManyWithoutSubmissionInputSchema: z.ZodType<Prisma.SubmissionTestcaseUncheckedUpdateManyWithoutSubmissionInput> = z.object({
  testcaseId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  status: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  stdout: z.union([ z.string(),z.lazy(() => NullableStringFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  problemId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const ProblemLanguageFindFirstArgsSchema: z.ZodType<Prisma.ProblemLanguageFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ ProblemLanguageOrderByWithRelationInputSchema.array(),ProblemLanguageOrderByWithRelationInputSchema ]).optional(),
  cursor: ProblemLanguageWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ ProblemLanguageScalarFieldEnumSchema,ProblemLanguageScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export const ProblemLanguageFindFirstOrThrowArgsSchema: z.ZodType<Prisma.ProblemLanguageFindFirstOrThrowArgs> = z.object({
  select: ProblemLanguageSelectSchema.optional(),
  include: ProblemLanguageIncludeSchema.optional(),
  where: ProblemLanguageWhereInputSchema.optional(),
  orderBy: z.union([ ProblemLanguageOrderByWithRelationInputSchema.array(),ProblemLanguageOrderByWithRelationInputSchema ]).optional(),
...
export const ProblemLanguageFindManyArgsSchema: z.ZodType<Prisma.ProblemLanguageFindManyArgs> = z.object({
  select: ProblemLanguageSelectSchema.optional(),
  include: ProblemLanguageIncludeSchema.optional(),
  where: ProblemLanguageWhereInputSchema.optional(),
  orderBy: z.union([ ProblemLanguageOrderByWithRelationInputSchema.array(),ProblemLanguageOrderByWithRelationInputSchema ]).optional(),
...
export const ProblemLanguageAggregateArgsSchema: z.ZodType<Prisma.ProblemLanguageAggregateArgs> = z.object({
  where: ProblemLanguageWhereInputSchema.optional(),
  orderBy: z.union([ ProblemLanguageOrderByWithRelationInputSchema.array(),ProblemLanguageOrderByWithRelationInputSchema ]).optional(),
  cursor: ProblemLanguageWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
...
export const ProblemLanguageGroupByArgsSchema: z.ZodType<Prisma.ProblemLanguageGroupByArgs> = z.object({
  where: ProblemLanguageWhereInputSchema.optional(),
  orderBy: z.union([ ProblemLanguageOrderByWithAggregationInputSchema.array(),ProblemLanguageOrderByWithAggregationInputSchema ]).optional(),
...
export const ProblemLanguageFindUniqueArgsSchema: z.ZodType<Prisma.ProblemLanguageFindUniqueArgs> = z.object({
  select: ProblemLanguageSelectSchema.optional(),
  include: ProblemLanguageIncludeSchema.optional(),
  where: ProblemLanguageWhereUniqueInputSchema,
}).strict() ;

export const ProblemLanguageFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.ProblemLanguageFindUniqueOrThrowArgs> = z.object({
  select: ProblemLanguageSelectSchema.optional(),
  include: ProblemLanguageIncludeSchema.optional(),
  where: ProblemLanguageWhereUniqueInputSchema,
}).strict() ;
...
export const SubmissionTestcaseFindFirstArgsSchema: z.ZodType<Prisma.SubmissionTestcaseFindFirstArgs> = z.object({
  ...
  orderBy: z.union([ SubmissionTestcaseOrderByWithRelationInputSchema.array(),SubmissionTestcaseOrderByWithRelationInputSchema ]).optional(),
  cursor: SubmissionTestcaseWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ SubmissionTestcaseScalarFieldEnumSchema,SubmissionTestcaseScalarFieldEnumSchema.array() ]).optional(),
}).strict() ;

export const SubmissionTestcaseFindFirstOrThrowArgsSchema: z.ZodType<Prisma.SubmissionTestcaseFindFirstOrThrowArgs> = z.object({
  select: SubmissionTestcaseSelectSchema.optional(),
  include: SubmissionTestcaseIncludeSchema.optional(),
  where: SubmissionTestcaseWhereInputSchema.optional(),
  orderBy: z.union([ SubmissionTestcaseOrderByWithRelationInputSchema.array(),SubmissionTestcaseOrderByWithRelationInputSchema ]).optional(),
...
export const SubmissionTestcaseFindManyArgsSchema: z.ZodType<Prisma.SubmissionTestcaseFindManyArgs> = z.object({
  select: SubmissionTestcaseSelectSchema.optional(),
  include: SubmissionTestcaseIncludeSchema.optional(),
  where: SubmissionTestcaseWhereInputSchema.optional(),
  orderBy: z.union([ SubmissionTestcaseOrderByWithRelationInputSchema.array(),SubmissionTestcaseOrderByWithRelationInputSchema ]).optional(),
...
export const SubmissionTestcaseAggregateArgsSchema: z.ZodType<Prisma.SubmissionTestcaseAggregateArgs> = z.object({
  where: SubmissionTestcaseWhereInputSchema.optional(),
  orderBy: z.union([ SubmissionTestcaseOrderByWithRelationInputSchema.array(),SubmissionTestcaseOrderByWithRelationInputSchema ]).optional(),
  cursor: SubmissionTestcaseWhereUniqueInputSchema.optional(),
  take: z.number().optional(),
...
export const SubmissionTestcaseGroupByArgsSchema: z.ZodType<Prisma.SubmissionTestcaseGroupByArgs> = z.object({
  where: SubmissionTestcaseWhereInputSchema.optional(),
  orderBy: z.union([ SubmissionTestcaseOrderByWithAggregationInputSchema.array(),SubmissionTestcaseOrderByWithAggregationInputSchema ]).optional(),
...
export const SubmissionTestcaseFindUniqueArgsSchema: z.ZodType<Prisma.SubmissionTestcaseFindUniqueArgs> = z.object({
  select: SubmissionTestcaseSelectSchema.optional(),
  include: SubmissionTestcaseIncludeSchema.optional(),
  where: SubmissionTestcaseWhereUniqueInputSchema,
}).strict() ;

export const SubmissionTestcaseFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.SubmissionTestcaseFindUniqueOrThrowArgs> = z.object({
  select: SubmissionTestcaseSelectSchema.optional(),
  include: SubmissionTestcaseIncludeSchema.optional(),
  where: SubmissionTestcaseWhereUniqueInputSchema,
}).strict() ;
...
export const updateManyResourceCreateManyAndReturnArgsSchema: z.ZodType<Prisma.updateManyResourceCreateManyAndReturnArgs> = z.object({
  data: z.union([ ResourceUpdateManyMutationInputSchema,ResourceUncheckedUpdateManyInputSchema ]),
  where: ResourceWhereInputSchema.optional(),
}).strict() ;
...
export const updateManyActionCreateManyAndReturnArgsSchema: z.ZodType<Prisma.updateManyActionCreateManyAndReturnArgs> = z.object({
  data: z.union([ ActionUpdateManyMutationInputSchema,ActionUncheckedUpdateManyInputSchema ]),
  where: ActionWhereInputSchema.optional(),
}).strict() ;
...
export const updateManyLanguageCreateManyAndReturnArgsSchema: z.ZodType<Prisma.updateManyLanguageCreateManyAndReturnArgs> = z.object({
  data: z.union([ LanguageUpdateManyMutationInputSchema,LanguageUncheckedUpdateManyInputSchema ]),
  where: LanguageWhereInputSchema.optional(),
}).strict() ;
...
export const ProblemLanguageCreateArgsSchema: z.ZodType<Prisma.ProblemLanguageCreateArgs> = z.object({
  select: ProblemLanguageSelectSchema.optional(),
  include: ProblemLanguageIncludeSchema.optional(),
  data: z.union([ ProblemLanguageCreateInputSchema,ProblemLanguageUncheckedCreateInputSchema ]),
}).strict() ;

export const ProblemLanguageUpsertArgsSchema: z.ZodType<Prisma.ProblemLanguageUpsertArgs> = z.object({
  select: ProblemLanguageSelectSchema.optional(),
  include: ProblemLanguageIncludeSchema.optional(),
  where: ProblemLanguageWhereUniqueInputSchema,
  create: z.union([ ProblemLanguageCreateInputSchema,ProblemLanguageUncheckedCreateInputSchema ]),
  update: z.union([ ProblemLanguageUpdateInputSchema,ProblemLanguageUncheckedUpdateInputSchema ]),
}).strict() ;

export const ProblemLanguageCreateManyArgsSchema: z.ZodType<Prisma.ProblemLanguageCreateManyArgs> = z.object({
  data: z.union([ ProblemLanguageCreateManyInputSchema,ProblemLanguageCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export const ProblemLanguageCreateManyAndReturnArgsSchema: z.ZodType<Prisma.ProblemLanguageCreateManyAndReturnArgs> = z.object({
  data: z.union([ ProblemLanguageCreateManyInputSchema,ProblemLanguageCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export const ProblemLanguageDeleteArgsSchema: z.ZodType<Prisma.ProblemLanguageDeleteArgs> = z.object({
  select: ProblemLanguageSelectSchema.optional(),
  include: ProblemLanguageIncludeSchema.optional(),
  where: ProblemLanguageWhereUniqueInputSchema,
}).strict() ;

export const ProblemLanguageUpdateArgsSchema: z.ZodType<Prisma.ProblemLanguageUpdateArgs> = z.object({
  select: ProblemLanguageSelectSchema.optional(),
  include: ProblemLanguageIncludeSchema.optional(),
  data: z.union([ ProblemLanguageUpdateInputSchema,ProblemLanguageUncheckedUpdateInputSchema ]),
  where: ProblemLanguageWhereUniqueInputSchema,
}).strict() ;

export const ProblemLanguageUpdateManyArgsSchema: z.ZodType<Prisma.ProblemLanguageUpdateManyArgs> = z.object({
  data: z.union([ ProblemLanguageUpdateManyMutationInputSchema,ProblemLanguageUncheckedUpdateManyInputSchema ]),
  where: ProblemLanguageWhereInputSchema.optional(),
}).strict() ;

export const updateManyProblemLanguageCreateManyAndReturnArgsSchema: z.ZodType<Prisma.updateManyProblemLanguageCreateManyAndReturnArgs> = z.object({
  data: z.union([ ProblemLanguageUpdateManyMutationInputSchema,ProblemLanguageUncheckedUpdateManyInputSchema ]),
  where: ProblemLanguageWhereInputSchema.optional(),
}).strict() ;

export const ProblemLanguageDeleteManyArgsSchema: z.ZodType<Prisma.ProblemLanguageDeleteManyArgs> = z.object({
  where: ProblemLanguageWhereInputSchema.optional(),
}).strict() ;
...
export const updateManySubmissionCreateManyAndReturnArgsSchema: z.ZodType<Prisma.updateManySubmissionCreateManyAndReturnArgs> = z.object({
  data: z.union([ SubmissionUpdateManyMutationInputSchema,SubmissionUncheckedUpdateManyInputSchema ]),
  where: SubmissionWhereInputSchema.optional(),
}).strict() ;
...
export const SubmissionTestcaseCreateArgsSchema: z.ZodType<Prisma.SubmissionTestcaseCreateArgs> = z.object({
  select: SubmissionTestcaseSelectSchema.optional(),
  include: SubmissionTestcaseIncludeSchema.optional(),
  data: z.union([ SubmissionTestcaseCreateInputSchema,SubmissionTestcaseUncheckedCreateInputSchema ]),
}).strict() ;

export const SubmissionTestcaseUpsertArgsSchema: z.ZodType<Prisma.SubmissionTestcaseUpsertArgs> = z.object({
  select: SubmissionTestcaseSelectSchema.optional(),
  include: SubmissionTestcaseIncludeSchema.optional(),
  where: SubmissionTestcaseWhereUniqueInputSchema,
  create: z.union([ SubmissionTestcaseCreateInputSchema,SubmissionTestcaseUncheckedCreateInputSchema ]),
  update: z.union([ SubmissionTestcaseUpdateInputSchema,SubmissionTestcaseUncheckedUpdateInputSchema ]),
}).strict() ;

export const SubmissionTestcaseCreateManyArgsSchema: z.ZodType<Prisma.SubmissionTestcaseCreateManyArgs> = z.object({
  data: z.union([ SubmissionTestcaseCreateManyInputSchema,SubmissionTestcaseCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export const SubmissionTestcaseCreateManyAndReturnArgsSchema: z.ZodType<Prisma.SubmissionTestcaseCreateManyAndReturnArgs> = z.object({
  data: z.union([ SubmissionTestcaseCreateManyInputSchema,SubmissionTestcaseCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict() ;

export const SubmissionTestcaseDeleteArgsSchema: z.ZodType<Prisma.SubmissionTestcaseDeleteArgs> = z.object({
  select: SubmissionTestcaseSelectSchema.optional(),
  include: SubmissionTestcaseIncludeSchema.optional(),
  where: SubmissionTestcaseWhereUniqueInputSchema,
}).strict() ;

export const SubmissionTestcaseUpdateArgsSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateArgs> = z.object({
  select: SubmissionTestcaseSelectSchema.optional(),
  include: SubmissionTestcaseIncludeSchema.optional(),
  data: z.union([ SubmissionTestcaseUpdateInputSchema,SubmissionTestcaseUncheckedUpdateInputSchema ]),
  where: SubmissionTestcaseWhereUniqueInputSchema,
}).strict() ;

export const SubmissionTestcaseUpdateManyArgsSchema: z.ZodType<Prisma.SubmissionTestcaseUpdateManyArgs> = z.object({
  data: z.union([ SubmissionTestcaseUpdateManyMutationInputSchema,SubmissionTestcaseUncheckedUpdateManyInputSchema ]),
  where: SubmissionTestcaseWhereInputSchema.optional(),
}).strict() ;

export const updateManySubmissionTestcaseCreateManyAndReturnArgsSchema: z.ZodType<Prisma.updateManySubmissionTestcaseCreateManyAndReturnArgs> = z.object({
  data: z.union([ SubmissionTestcaseUpdateManyMutationInputSchema,SubmissionTestcaseUncheckedUpdateManyInputSchema ]),
  where: SubmissionTestcaseWhereInputSchema.optional(),
}).strict() ;

export const SubmissionTestcaseDeleteManyArgsSchema: z.ZodType<Prisma.SubmissionTestcaseDeleteManyArgs> = z.object({
  where: SubmissionTestcaseWhereInputSchema.optional(),
}).strict() ;
...
export const updateManyTestcaseCreateManyAndReturnArgsSchema: z.ZodType<Prisma.updateManyTestcaseCreateManyAndReturnArgs> = z.object({
  data: z.union([ TestcaseUpdateManyMutationInputSchema,TestcaseUncheckedUpdateManyInputSchema ]),
  where: TestcaseWhereInputSchema.optional(),
}).strict() ;
